...
public class HDPathSapientGeneratedJunit4Test {
    ...
    ChildNumber childNumber2 = new ChildNumber(0, false);
    ChildNumber[][] childNumberArray5 = new ChildNumber[][] { childNumber2 };
    ...
    public void parsePathWhenNIsEmptyAndIsHard() {
        ...
        //stringList.add("\"2'\"");
        //stringList.add("\"2\"");
        //stringList.add("\"1000000000\"");
        //doReturn(stringList).when(SEPARATOR_SPLITTERMock).splitToList("m/0'/1/2'/2/1000000000");
        //Act Statement(s)
        //HDPath result = HDPath.parsePath("m/0'/1/2'/2/1000000000");
        //ChildNumber childNumber = new ChildNumber(0, false);
        //ChildNumber childNumber2 = new ChildNumber(0, false);
        //ChildNumber childNumber3 = new ChildNumber(0, false);
        ...
        //Assert statement(s)
        //assertThat(result, equalTo(hDPath));
        //verify(SEPARATOR_SPLITTERMock).splitToList("m/0'/1/2'/2/1000000000");
    }
    ...
    public void extendTest() {
        ...
        //ChildNumber[][] childNumberArray3 = new ChildNumber[][] { childNumber7 };
        //ChildNumber[] childNumberArray2 = new ChildNumber[] { childNumberArray3 };
        //ChildNumber childNumber8 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray5 = new ChildNumber[][] { childNumber8 };
        //ChildNumber[] childNumberArray4 = new ChildNumber[] { childNumberArray5 };
        //ChildNumber[] childNumberArray = new ChildNumber[] { childNumberArray2, childNumberArray4 };
        //Act Statement(s)
        //HDPath result = target.extend(childNumber6, childNumberArray);
        //ChildNumber childNumber9 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray7 = new ChildNumber[][] { childNumber9 };
        //ChildNumber[] childNumberArray6 = new ChildNumber[] { childNumberArray7 };
        //ChildNumber childNumber10 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray9 = new ChildNumber[][] { childNumber10 };
        //ChildNumber[] childNumberArray8 = new ChildNumber[] { childNumberArray9 };
        //ArrayList<ChildNumber> childNumberList2 = new ArrayList<>();
        //childNumberList2.add(childNumber6);
