...
public class BIP38PrivateKeySapientGeneratedJunit4Test {
    ...
    public void fromBase58WhenVersionNotEquals1ThrowsAddressFormatExceptionInvalidPrefix() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            base58.when(() -> Base58.decodeChecked("KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYZbbvxZei6R4QbV8zL")).thenReturn(byteArray);
            thrown.expect(ArrayIndexOutOfBoundsException.class);
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYZbbvxZei6R4QbV8zL");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYZbbvxZei6R4QbV8zL"), atLeast(1));
        }
    }
    ...
    public void fromBase58WhenBytesLengthNotEquals38ThrowsAddressFormatExceptionInvalidDataLength() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            base58.when(() -> Base58.decodeChecked("5JrL5aZqTbHJGJGzC8ZeeX76rVwzJLrjzJ9vJq3vJz8JZvWJg5d")).thenReturn(byteArray);
            ...
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "5JrL5aZqTbHJGJGzC8ZeeX76rVwzJLrjzJ9vJq3vJz8JZvWJg5d");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("5JrL5aZqTbHJGJGzC8ZeeX76rVwzJLrjzJ9vJq3vJz8JZvWJg5d"), atLeast(1));
        }
    }
    ...
    public void fromBase58When1IndexOfBytesAnd1NotEquals0ThrowsAddressFormatException() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            byte[] byteArray = new byte[]{};
            base58.when(() -> Base58.decodeChecked("5JrLd5UDzv3TtMqZoLjhvM3QCW6dVfT5LZJjJZJz5Jv5JrLd5UDzv3TtMqZoLjhvM3QCW6dVfT5LZJjJZJz5Jv")).thenReturn(byteArray);
            thrown.expect(ArrayIndexOutOfBoundsException.class);
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "5JrLd5UDzv3TtMqZoLjhvM3QCW6dVfT5LZJjJZJz5Jv5JrLd5UDzv3TtMqZoLjhvM3QCW6dVfT5LZJjJZJz5Jv");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("5JrLd5UDzv3TtMqZoLjhvM3QCW6dVfT5LZJjJZJz5Jv5JrLd5UDzv3TtMqZoLjhvM3QCW6dVfT5LZJjJZJz5Jv"), atLeast(1));
        }
    }
    ...
    public void fromBase58When1IndexOfBytesAnd2NotEquals0ThrowsAddressFormatException() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            byte[] byteArray = new byte[]{};
            base58.when(() -> Base58.decodeChecked("KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYkCw4Bp8yMwZ1x5vFom")).thenReturn(byteArray);
            thrown.expect(ArrayIndexOutOfBoundsException.class);
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYkCw4Bp8yMwZ1x5vFom");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYkCw4Bp8yMwZ1x5vFom"), atLeast(1));
        }
    }
    ...
    public void fromBase58When1IndexOfBytesAnd8NotEquals0ThrowsAddressFormatException() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            base58.when(() -> Base58.decodeChecked("KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYjgd9M7rFUv1JWm5pTs")).thenReturn(byteArray);
            ...
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYjgd9M7rFUv1JWm5pTs");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYjgd9M7rFUv1JWm5pTs"), atLeast(1));
        }
    }
    ...
    public void fromBase58When1IndexOfBytesAnd16NotEquals0ThrowsAddressFormatException() throws AddressFormatException {
        ...
        //Arrange Statement(s)
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            byte[] byteArray = new byte[]{(byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0};
            base58.when(() -> Base58.decodeChecked("6PfQcLZP1p1vX7Zj7zqg8qUv5XJ3zQz5jz9JjJ5YJZK9JgZJ6E")).thenReturn(byteArray);
            AddressFormatException addressFormatException = new AddressFormatException("Bit 0x10 reserved for future use.");
            thrown.expect(AddressFormatException.class);
            thrown.expectMessage(addressFormatException.getMessage());
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "6PfQcLZP1p1vX7Zj7zqg8qUv5XJ3zQz5jz9JjJ5YJZK9JgZJ6E");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("6PfQcLZP1p1vX7Zj7zqg8qUv5XJ3zQz5jz9JjJ5YJZK9JgZJ6E"), atLeast(1));
        }
    }
    ...
    public void fromBase58When1IndexOfBytesAnd192NotEquals192ThrowsAddressFormatException() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            base58.when(() -> Base58.decodeChecked("6PfRWL8XKc1z2dZzrjYZJi9jFJv8gJv8jzJ1JzZv5Jz5")).thenReturn(byteArray);
            ...
            thrown.expectMessage(addressFormatException.getMessage());
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "6PfRWL8XKc1z2dZzrjYZJi9jFJv8gJv8jzJ1JzZv5Jz5");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("6PfRWL8XKc1z2dZzrjYZJi9jFJv8gJv8jzJ1JzZv5Jz5"), atLeast(1));
        }
    }
    ...
    public void fromBase58When1IndexOfBytesAnd192Equals192AndNotHasLotAndSequence() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            byte[] byteArray = new byte[]{};
            base58.when(() -> Base58.decodeChecked("01abcdef0123456789abcdef0123456789abcdef")).thenReturn(byteArray);
            thrown.expect(ArrayIndexOutOfBoundsException.class);
            //Act Statement(s)
            BIP38PrivateKey.fromBase58(networkMock, "01abcdef0123456789abcdef0123456789abcdef");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("01abcdef0123456789abcdef0123456789abcdef"), atLeast(1));
        }
    }
    ...
    public void toBase58Test() throws AddressFormatException {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            base58.when(() -> Base58.encodeChecked(1, (byte[]) null)).thenReturn("");
    ...
    public void decryptWhenPassFactorSignumLessThan0ThrowsIllegalStateException() throws BadPassphraseException, AddressFormatException {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class, CALLS_REAL_METHODS);
            ...
            byteUtils.when(() -> ByteUtils.concat(byteArray3, byteArray4)).thenReturn(byteArray2);
            preconditions.when(() -> Preconditions.checkState(true)).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray5 = new byte[]{(byte) 108, (byte) -128, (byte) -5, (byte) -63, (byte) 12, (byte) -106, (byte) 81, (byte) -38, (byte) -63, (byte) -88, (byte) -54, (byte) -34, (byte) 60, (byte) -112, (byte) 60, (byte) -107, (byte) -25, (byte) -107, (byte) 24, (byte) -17, (byte) 52, (byte) -65, (byte) 9, (byte) -62, (byte) 70, (byte) 16, (byte) 63, (byte) -99, (byte) -25, (byte) 38, (byte) 10, (byte) -26};
            sha256Hash.when(() -> Sha256Hash.hashTwice(byteArray2)).thenReturn(byteArray5);
            byteUtils.when(() -> ByteUtils.bytesToBigInteger(byteArray5)).thenReturn(new BigInteger("0"));
            eCKey.when(() -> ECKey.fromPrivate(new BigInteger("0"), true)).thenReturn(eCKeyMock);
            byte[] byteArray6 = new byte[]{};
            doReturn(byteArray6).when(eCKeyMock).getPubKey();
            byte[] byteArray7 = new byte[]{(byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0};
            byte[] byteArray8 = new byte[]{};
            byteUtils.when(() -> ByteUtils.concat(byteArray8, byteArray4)).thenReturn(byteArray7);
            byte[] byteArray9 = new byte[]{};
            byte[] byteArray10 = new byte[]{};
            byte[] byteArray11 = new byte[]{};
            byteUtils.when(() -> ByteUtils.concat(byteArray10, byteArray11)).thenReturn(byteArray9);
            byte[] byteArray12 = new byte[]{};
            byte[] byteArray13 = new byte[]{};
            byte[] byteArray14 = new byte[]{};
            byteUtils.when(() -> ByteUtils.concat(byteArray13, byteArray14)).thenReturn(byteArray12);
            byte[] byteArray15 = new byte[]{};
            sha256Hash.when(() -> Sha256Hash.hashTwice(byteArray12)).thenReturn(byteArray15);
            byteUtils.when(() -> ByteUtils.bytesToBigInteger(byteArray15)).thenReturn(new BigInteger("0"));
            IllegalStateException illegalStateException = new IllegalStateException();
            preconditions.when(() -> Preconditions.checkState(false)).thenThrow(illegalStateException);
            BIP38PrivateKey target = BIP38PrivateKey.fromBase58(networkMock, "base58");
            thrown.expect(IllegalStateException.class);
            ...
            byteUtils.verify(() -> ByteUtils.bytesToBigInteger(byteArray5), atLeast(1));
            eCKey.verify(() -> ECKey.fromPrivate(new BigInteger("0"), true), atLeast(1));
            verify(eCKeyMock, atLeast(1)).getPubKey();
            byteUtils.verify(() -> ByteUtils.concat(byteArray8, byteArray4), atLeast(1));
            byteUtils.verify(() -> ByteUtils.concat(byteArray10, byteArray11), atLeast(1));
            byteUtils.verify(() -> ByteUtils.concat(byteArray13, byteArray14), atLeast(1));
            sha256Hash.verify(() -> Sha256Hash.hashTwice(byteArray12), atLeast(1));
            byteUtils.verify(() -> ByteUtils.bytesToBigInteger(byteArray15), atLeast(1));
            preconditions.verify(() -> Preconditions.checkState(false), atLeast(1));
        }
    }
    ...
    public void decryptWhenArraysNotEqualsActualAddressHashAddressHashThrowsBIP38PrivateKeyBadPassphraseException() throws BadPassphraseException, AddressFormatException {
        ...
        try (MockedStatic<SCrypt> sCrypt = mockStatic(SCrypt.class);
            ...
            byte[] byteArray3 = new byte[]{(byte) 112, (byte) 97, (byte) 115, (byte) 115, (byte) 112, (byte) 104, (byte) 114, (byte) 97, (byte) 115, (byte) 101};
            ...
            eCKey.when(() -> ECKey.fromPrivate(new BigInteger("112144865100060826447111390309925685492517817299313599270929714654447997979723"), true)).thenReturn(eCKeyMock);
            byte[] byteArray7 = new byte[]{};
            ...
            eCKey.verify(() -> ECKey.fromPrivate(new BigInteger("112144865100060826447111390309925685492517817299313599270929714654447997979723"), true), atLeast(1));
            verify(eCKeyMock, atLeast(1)).getPubKey();
    ...
    public void decryptWhenArraysEqualsActualAddressHashAddressHash() throws BadPassphraseException, AddressFormatException {
        ...
        try (MockedStatic<SCrypt> sCrypt = mockStatic(SCrypt.class);
             ...
             MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            byte[] byteArray = new byte[]{(byte) 0};
            base58.when(() -> Base58.decodeChecked("5JqzZzLZz6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ")).thenReturn(byteArray);
            byte[] byteArray2 = new byte[]{(byte) 0, (byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6, (byte) 7, (byte) 8, (byte) 9, (byte) 10, (byte) 11, (byte) 12, (byte) 13, (byte) 14, (byte) 15, (byte) 16, (byte) 17, (byte) 18, (byte) 19, (byte) 20, (byte) 21, (byte) 22, (byte) 23, (byte) 24, (byte) 25, (byte) 26, (byte) 27, (byte) 28, (byte) 29, (byte) 30, (byte) 31};
            byte[] byteArray3 = new byte[]{(byte) 109, (byte) 121, (byte) 80, (byte) 97, (byte) 115, (byte) 115, (byte) 112, (byte) 104, (byte) 114, (byte) 97, (byte) 115, (byte) 101};
            byte[] byteArray4 = new byte[]{(byte) 0, (byte) 1, (byte) 2, (byte) 3};
            sCrypt.when(() -> SCrypt.generate(byteArray3, byteArray4, 16384, 8, 8, 32)).thenReturn(byteArray2);
            byte[] byteArray5 = new byte[]{(byte) 0, (byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6, (byte) 7, (byte) 8, (byte) 9, (byte) 10, (byte) 11, (byte) 12, (byte) 13, (byte) 14, (byte) 15, (byte) 16, (byte) 17, (byte) 18, (byte) 19, (byte) 20, (byte) 21, (byte) 22, (byte) 23, (byte) 24, (byte) 25, (byte) 26, (byte) 27, (byte) 28, (byte) 29, (byte) 30, (byte) 31, (byte) 32, (byte) 33, (byte) 34, (byte) 35, (byte) 36, (byte) 37, (byte) 38, (byte) 39};
            byte[] byteArray6 = new byte[]{(byte) 0, (byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6, (byte) 7};
            byteUtils.when(() -> ByteUtils.concat(byteArray2, byteArray6)).thenReturn(byteArray5);
            eCKey.when(() -> ECKey.fromPrivate(new BigInteger("65414728349203319658356629128582614555183077209586930130628532414801330598433"), true)).thenReturn(eCKeyMock);
            byte[] byteArray7 = new byte[]{};
            doReturn(byteArray7).when(eCKeyMock).getPubKey();
            byte[] byteArray8 = new byte[]{(byte) 0, (byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6, (byte) 7, (byte) 8, (byte) 9, (byte) 10, (byte) 11};
            byte[] byteArray9 = new byte[]{};
            ...
            byte[] byteArray10 = new byte[]{(byte) 0};
            sCrypt.when(() -> SCrypt.generate(byteArray7, byteArray8, 1024, 1, 1, 64)).thenReturn(byteArray10);
            BIP38PrivateKey target = BIP38PrivateKey.fromBase58(networkMock, "5JqzZzLZz6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ");
            thrown.expect(ArrayIndexOutOfBoundsException.class);
            //Act Statement(s)
            target.decrypt("myPassphrase");
            //Assert statement(s)
            base58.verify(() -> Base58.decodeChecked("5JqzZzLZz6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ6Jz5yZzZ"), atLeast(1));
            sCrypt.verify(() -> SCrypt.generate(byteArray3, byteArray4, 16384, 8, 8, 32), atLeast(1));
            byteUtils.verify(() -> ByteUtils.concat(byteArray2, byteArray6), atLeast(1));
            eCKey.verify(() -> ECKey.fromPrivate(new BigInteger("65414728349203319658356629128582614555183077209586930130628532414801330598433"), true), atLeast(1));
            verify(eCKeyMock, atLeast(1)).getPubKey();
            byteUtils.verify(() -> ByteUtils.concat(byteArray9, byteArray6), atLeast(1));
            sCrypt.verify(() -> SCrypt.generate(byteArray7, byteArray8, 1024, 1, 1, 64), atLeast(1));
        }
