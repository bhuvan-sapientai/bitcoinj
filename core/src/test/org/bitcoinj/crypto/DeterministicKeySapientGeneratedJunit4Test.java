...
public class DeterministicKeySapientGeneratedJunit4Test {
    ...
    public void getPathAsStringTest() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("987654321"), (DeterministicKey) null));
    ...
    public void getChildNumberWhenChildNumberPathSizeNotEquals0() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("1234567890"), (DeterministicKey) null);
            //Act Statement(s)
            ChildNumber result = target.getChildNumber();
    ...
    public void getIdentifierTest() {
        ...
        try (MockedStatic<CryptoUtils> cryptoUtils = mockStatic(CryptoUtils.class);
            ...
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray3, eCPointMock, true, new BigInteger("1"), (DeterministicKey) null);
            //Act Statement(s)
    ...
    public void dropPrivateBytesWhenDefaultBranch() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            childNumberList.add(childNumber2);
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("1234567890"), (DeterministicKey) null));
    ...
    public void dropParentWhenDefaultBranchAndDefaultBranch() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            childNumberList.add(childNumber2);
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("10"), (DeterministicKey) null);
            //Act Statement(s)
            DeterministicKey result = target.dropParent();
            byte[] byteArray2 = new byte[]{};
            LazyECPoint lazyECPoint = new LazyECPoint(eCPointMock, true);
            LazyECPoint lazyECPoint2 = lazyECPoint.compress();
            DeterministicKey deterministicKey = new DeterministicKey(childNumberPathMock, byteArray2, lazyECPoint2, new BigInteger("10"), (DeterministicKey) null);
            //Assert statement(s)
            assertThat(result, equalTo(deterministicKey));
    ...
    public void addChecksumTest() {
        ...
        try (MockedStatic<Sha256Hash> sha256Hash = mockStatic(Sha256Hash.class)) {
            ...
            byte[] byteResultArray = new byte[]{(byte) 1, (byte) 2, (byte) 3, (byte) 0, (byte) 0, (byte) 0, (byte) 0};
            //Assert statement(s)
            assertThat(result, equalTo(byteResultArray));
    ...
    public void isPubKeyOnlyWhenParentIsNull() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            childNumberList.add(childNumber2);
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray, eCPointMock, true, (BigInteger) null, (DeterministicKey) null);
            //Act Statement(s)
            boolean result = target.isPubKeyOnly();
            //Assert statement(s)
    ...
    public void sign1WhenDownCursorPubNotEqualsPubThrowsKeyCrypterExceptionPublicPrivateMismatch() throws KeyCrypterException {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class, CALLS_REAL_METHODS);
            ...
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray2, eCPointMock, true, new BigInteger("10"), (DeterministicKey) null));
            doReturn(false).when(target).isEncrypted();
    ...
    public void sign1WhenPrivateKeyIsNotNull() throws KeyCrypterException {
        ...
        try (MockedStatic<HDKeyDerivation> hDKeyDerivation = mockStatic(HDKeyDerivation.class);
            ...
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray, eCPointMock2, true, new BigInteger("10"), (DeterministicKey) null));
            doReturn(false).when(target).isEncrypted();
            ...
            verify(parentMock2, atLeast(1)).getFingerprint();
            verify(target, atLeast(1)).isEncrypted();
    ...
    public void sign1WhenPathIsNotEmptyAndDownCursorPubEqualsPubAndPrivateKeyIsNotNull() throws KeyCrypterException {
        ...
        try (MockedStatic<HDKeyDerivation> hDKeyDerivation = mockStatic(HDKeyDerivation.class);
            ...
            childNumberList.add(childNumber4);
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray, eCPointMock2, true, new BigInteger("1234567890"), (DeterministicKey) null));
            doReturn(false).when(target).isEncrypted();
            KeyCrypterException.PublicPrivateMismatch keyCrypterExceptionPublicPrivateMismatch = new KeyCrypterException.PublicPrivateMismatch("Could not decrypt bytes");
            thrown.expect(KeyCrypterException.PublicPrivateMismatch.class);
            thrown.expectMessage(keyCrypterExceptionPublicPrivateMismatch.getMessage());
    ...
    public void decrypt2WhenArraysNotEqualsKeyGetPubKeyGetPubKeyThrowsKeyCrypterExceptionPublicPrivateMismatch() throws KeyCrypterException {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            List<ChildNumber> childNumberList = new ArrayList<>();
            byte[] byteArray2 = new byte[]{};
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray2, eCPointMock2, true, new BigInteger("123456789"), (DeterministicKey) null);
    ...
    public void decrypt2WhenCreationTimeIsPresent() throws KeyCrypterException {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            List<ChildNumber> childNumberList = new ArrayList<>();
            byte[] byteArray2 = new byte[]{};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray2, eCPointMock2, true, new BigInteger("123456789"), (DeterministicKey) null));
            ...
            List<ChildNumber> childNumberList2 = new ArrayList<>();
            HDPath hDPath = HDPath.M(childNumberList2);
            byte[] byteArray3 = new byte[]{};
            DeterministicKey deterministicKey = new DeterministicKey(hDPath, byteArray3, new BigInteger("1780731860627700044960722568376592200742329637303199754547598369979440671"), (DeterministicKey) null);
    ...
    public void getPrivKeyWhenDownCursorPubNotEqualsPubThrowsKeyCrypterExceptionPublicPrivateMismatch() {
        ...
        try (MockedStatic<HDKeyDerivation> hDKeyDerivation = mockStatic(HDKeyDerivation.class);
            ...
            LazyECPoint lazyECPoint = new LazyECPoint(eCPointMock, false);
            doReturn(lazyECPoint).when(publicAsPointMock).compress();
            ChildNumber childNumber2 = new ChildNumber(0);
            List<ChildNumber> childNumberList = new ArrayList<>();
            childNumberList.add(childNumber2);
            ...
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray, eCPointMock2, true, new BigInteger("1234567890"), (DeterministicKey) null);
            KeyCrypterException.PublicPrivateMismatch keyCrypterExceptionPublicPrivateMismatch = new KeyCrypterException.PublicPrivateMismatch("Could not decrypt bytes");
            thrown.expect(KeyCrypterException.PublicPrivateMismatch.class);
            thrown.expectMessage(keyCrypterExceptionPublicPrivateMismatch.getMessage());
            //Act Statement(s)
    ...
    public void getPrivKeyWhenKeyIsNotNullThrowsIllegalStateException() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            childNumberList.add(childNumber2);
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("0"), (DeterministicKey) null);
            thrown.expect(IllegalStateException.class);
            //Act Statement(s)
            target.getPrivKey();
            //Assert statement(s)
    ...
    public void serializeWhenSerPositionEquals78() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class, CALLS_REAL_METHODS);
            ...
            childNumberList.add(childNumber2);
            byte[] byteArray = new byte[]{};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("0"), (DeterministicKey) null));
            doReturn(childNumberMock).when(target).getChildNumber();
            doReturn(0).when(childNumberMock).i();
            //Act Statement(s)
            byte[] result = target.serialize(networkMock, true);
    ...
    public void serialize1Test() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            ...
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray, eCPointMock, false, new BigInteger("123456789"), (DeterministicKey) null));
            byte[] byteArray2 = new byte[]{};
            doReturn(byteArray2).when(target).serialize(networkMock, true);
            NetworkParameters networkParameters = NetworkParameters.fromID("id1");
            //Act Statement(s)
            byte[] result = target.serialize(networkParameters, true);
            //Assert statement(s)
            assertThat(result, equalTo(byteArray2));
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(2));
    ...
    public void serializePrivB58WhenOutputScriptTypeNotEqualsScriptTypeP2WPKHThrowsIllegalStateException() {
        ...
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class);
            ...
            thrown.expectMessage(illegalStateException.getMessage());
            //Act Statement(s)
            target.serializePrivB58(networkMock, ScriptType.P2TR);
            //Assert statement(s)
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(1));
            preconditions.verify(() -> Preconditions.checkArgument(false), atLeast(2));
    ...
    public void serializePrivB58WhenSerPositionNotEquals78ThrowsIllegalStateException() {
        ...
        try (MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class);
            ...
            childNumberList.add(childNumber2);
            byte[] byteArray2 = new byte[]{(byte) 0};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray2, eCPointMock, true, new BigInteger("1"), (DeterministicKey) null));
            doReturn(childNumberMock).when(target).getChildNumber();
            doReturn(0).when(childNumberMock).i();
            byte[] byteArray3 = new byte[]{};
    ...
    public void serializePrivB58WhenNotPubAndSerPositionEquals78() {
        ...
        try (MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class);
            ...
            doReturn(byteArray3).when(target).getPrivKeyBytes33();
            //Act Statement(s)
            String result = target.serializePrivB58(networkMock, ScriptType.P2WPKH);
            //Assert statement(s)
            assertThat(result, equalTo("return_of_toBase58"));
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()), atLeast(1));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(1));
    ...
    public void serializePubB582Test() {
        ...
        try (MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class);
            ...
            List<ChildNumber> childNumberList = new ArrayList<>();
            byte[] byteArray2 = new byte[]{(byte) 0};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray2, eCPointMock, true, new BigInteger("123456789"), (DeterministicKey) null));
    ...
    public void serializePrivB582Test() {
        ...
        try (MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class);
            ...
            preconditions.when(() -> Preconditions.checkArgument(false)).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray = new byte[]{};
            deterministicKey.when(() -> DeterministicKey.toBase58(byteArray)).thenReturn("<result of serializePrivB58 method>");
            ChildNumber childNumber = new ChildNumber(0);
            List<ChildNumber> childNumberList = new ArrayList<>();
            childNumberList.add(childNumber);
            byte[] byteArray2 = new byte[]{(byte) 0};
            ...
            //Assert statement(s)
            assertThat(result, equalTo("<result of serializePrivB58 method>"));
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(2));
            preconditions.verify(() -> Preconditions.checkArgument(false), atLeast(1));
            deterministicKey.verify(() -> DeterministicKey.toBase58(byteArray), atLeast(1));
    ...
    public void deserializeB58Test() {
        ...
        try (MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class, CALLS_REAL_METHODS)) {
            deterministicKey.when(() -> DeterministicKey.deserializeB58((DeterministicKey) null, "sampleBase58String", networkMock)).thenReturn(deterministicKeyMock);
            //Act Statement(s)
            DeterministicKey result = DeterministicKey.deserializeB58("sampleBase58String", networkMock);
            //Assert statement(s)
            assertThat(result, equalTo(deterministicKeyMock));
            deterministicKey.verify(() -> DeterministicKey.deserializeB58((DeterministicKey) null, "sampleBase58String", networkMock), atLeast(1));
        }
    }
    ...
    public void deserializeB581Test() {
        ...
        try (MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class, CALLS_REAL_METHODS)) {
            doReturn(networkMock).when(paramsMock).network();
            deterministicKey.when(() -> DeterministicKey.deserializeB58("sampleBase58String", networkMock)).thenReturn(deterministicKeyMock);
            //Act Statement(s)
            DeterministicKey result = DeterministicKey.deserializeB58("sampleBase58String", paramsMock);
            //Assert statement(s)
            assertThat(result, equalTo(deterministicKeyMock));
            verify(paramsMock, atLeast(1)).network();
            deterministicKey.verify(() -> DeterministicKey.deserializeB58("sampleBase58String", networkMock), atLeast(1));
        }
    }
    ...
    public void setCreationTimeWhenParentIsNull() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            List<ChildNumber> childNumberList = new ArrayList<>();
            byte[] byteArray = new byte[]{(byte) 0};
            DeterministicKey target = new DeterministicKey(childNumberList, byteArray, eCPointMock, true, new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639934"), (DeterministicKey) null);
    ...
    public void setCreationTimeSecondsWhenCreationTimeSecsGreaterThan0() {
        ...
        try (MockedStatic<HDPath> hDPath = mockStatic(HDPath.class);
            ...
            //Act Statement(s)
            target.setCreationTimeSeconds(1620000000L);
            //Assert statement(s)
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(2));
            preconditions.verify(() -> Preconditions.checkArgument(false), atLeast(1));
    ...
    public void toStringWhenParentIsNull() {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class);
            ...
            childNumberList.add(childNumber);
            byte[] byteArray3 = new byte[]{(byte) 0};
            DeterministicKey target = spy(new DeterministicKey(childNumberList, byteArray3, eCPointMock, true, new BigInteger("1"), (DeterministicKey) null));
            doReturn("return_of_getPathAsString1").when(target).getPathAsString();
            Instant instant = (Instant) Instant.now();
            doReturn(Optional.of(instant)).when(target).creationTime();
            doReturn(false).when(target).isEncrypted();
    ...
    public void formatKeyWithAddressWhenIncludePrivateKeys() {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class);
            ...
            //Act Statement(s)
            target.formatKeyWithAddress(true, aesKeyMock, stringBuilder, networkMock, ScriptType.P2PKH, "some comment");
            //Assert statement(s)
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(1));
            preconditions.verify(() -> Preconditions.checkArgument(false), atLeast(2));
    ...
    public void formatKeyWithAddress1Test() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            doNothing().when(target).formatKeyWithAddress(true, aesKeyMock, stringBuilder, networkMock, ScriptType.P2PKH, "test comment");
            //Act Statement(s)
            target.formatKeyWithAddress(true, aesKeyMock, stringBuilder, paramsMock, ScriptType.P2PKH, "test comment");
            //Assert statement(s)
            verify(paramsMock).network();
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
            preconditions.verify(() -> Preconditions.checkArgument(true), atLeast(1));
            preconditions.verify(() -> Preconditions.checkArgument(false), atLeast(2));
            verify(target).formatKeyWithAddress(true, aesKeyMock, stringBuilder, networkMock, ScriptType.P2PKH, "test comment");
        }
    }
}
