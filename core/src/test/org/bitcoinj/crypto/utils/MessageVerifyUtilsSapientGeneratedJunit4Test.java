...
public class MessageVerifyUtilsSapientGeneratedJunit4Test {
    ...
    public void verifyMessageWhenSwitchScriptTypeCaseDefaultThrowsSignatureException() throws Exception {
        ...
        try (MockedStatic<ECKey> eCKey = mockStatic(ECKey.class)) {
            ...
            eCKey.when(() -> ECKey.signedMessageToKey("Hello, World!", "c2lnbmF0dXJlQmFzZTY0VmFsdWU=")).thenReturn(eCKeyMock);
            byte[] byteArray2 = new byte[]{};
            doReturn(byteArray2).when(eCKeyMock).getPubKeyHash();
            //Act Statement(s)
            MessageVerifyUtils.verifyMessage(addressMock, "Hello, World!", "c2lnbmF0dXJlQmFzZTY0VmFsdWU=");
            //Assert statement(s)
            verify(addressMock).getOutputScriptType();
            verify(addressMock).getHash();
            eCKey.verify(() -> ECKey.signedMessageToKey("Hello, World!", "c2lnbmF0dXJlQmFzZTY0VmFsdWU="), atLeast(1));
    ...
    public void verifyMessageWhenArraysEqualsScriptHashFromAddressScriptHashDerivedFromSig() throws Exception {
        ...
        try (MockedStatic<CryptoUtils> cryptoUtils = mockStatic(CryptoUtils.class);
            ...
            eCKey.when(() -> ECKey.signedMessageToKey("Hello, world!", "Hw+X8zjJ6zJL8z7JZJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJw==")).thenReturn(eCKey2);
            byte[] byteArray2 = new byte[]{};
            ...
            //Act Statement(s)
            MessageVerifyUtils.verifyMessage(addressMock, "Hello, world!", "Hw+X8zjJ6zJL8z7JZJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJw==");
            //Assert statement(s)
            verify(addressMock).getOutputScriptType();
            verify(addressMock).getHash();
            eCKey.verify(() -> ECKey.signedMessageToKey("Hello, world!", "Hw+X8zjJ6zJL8z7JZJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJzJw=="), atLeast(1));
    ...
    public void verifyMessageWhenCaughtExceptionThrowsSignatureException() throws SignatureException {
        ...
        thrown.expect(SignatureException.class);
        //Act Statement(s)
        MessageVerifyUtils.verifyMessage(addressMock, "Hello, world!", "c2lnbmF0dXJlQmFzZTY0");
        //Assert statement(s)
        verify(addressMock).getOutputScriptType();
    }
    ...
    public void verifyMessageWhenArraysNotEqualsPubKeyHashFromAddressPubKeyHashFromSignatureThrowsSignatureException() throws SignatureException {
        ...
        try (MockedStatic<ECKey> eCKey = mockStatic(ECKey.class)) {
            ...
            doReturn(byteArray).when(addressMock).getHash();
            ECKey eCKey2 = new ECKey();
            eCKey.when(() -> ECKey.signedMessageToKey("string message", "valid signature in Base64 format")).thenReturn(eCKey2);
            thrown.expect(SignatureException.class);
            //Act Statement(s)
            MessageVerifyUtils.verifyMessage(addressMock, "string message", "valid signature in Base64 format");
            //Assert statement(s)
            verify(addressMock).getOutputScriptType();
            verify(addressMock).getHash();
            eCKey.verify(() -> ECKey.signedMessageToKey("string message", "valid signature in Base64 format"), atLeast(1));
        }
    }
