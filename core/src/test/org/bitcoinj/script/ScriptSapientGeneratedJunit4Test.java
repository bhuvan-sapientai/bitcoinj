...
public class ScriptSapientGeneratedJunit4Test {
    ...
    public void getCreationTimeSecondsTest() {
        ...
        //Assert statement(s)
        //assertThat(result, equalTo(1703143314L));
    }
    ...
    public void createMultiSigOutputScriptWhenCaughtIOExceptionThrowsRuntimeException() {
        ...
        try (MockedStatic<Script> script = mockStatic(Script.class, CALLS_REAL_METHODS)) {
            ...
            byte[] byteArray = new byte[]{};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray))).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray2 = new byte[]{(byte) 3, (byte) 68, (byte) 41, (byte) -21, (byte) -113, (byte) -26, (byte) 119, (byte) -57, (byte) -102, (byte) 120, (byte) -106, (byte) 45, (byte) -66, (byte) 61, (byte) 75, (byte) 120, (byte) -45, (byte) 1, (byte) 74, (byte) 11, (byte) -17, (byte) -44, (byte) 117, (byte) -117, (byte) 99, (byte) 119, (byte) 104, (byte) 63, (byte) -92, (byte) 53, (byte) 13, (byte) 63, (byte) 80};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray2))).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray3 = new byte[]{(byte) 3, (byte) 55, (byte) -69, (byte) -98, (byte) -26, (byte) 26, (byte) -86, (byte) 64, (byte) 110, (byte) 17, (byte) 37, (byte) -38, (byte) -113, (byte) -20, (byte) 124, (byte) 60, (byte) 62, (byte) 62, (byte) 65, (byte) 74, (byte) -117, (byte) 99, (byte) -9, (byte) -86, (byte) -29, (byte) 98, (byte) -87, (byte) 71, (byte) -106, (byte) 37, (byte) -21, (byte) 106, (byte) -17};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray3))).thenAnswer((Answer<Void>) invocation -> null);
            script.when(() -> Script.encodeToOpN(3)).thenReturn(1);
            thrown.expect(RuntimeException.class);
            ...
            script.verify(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray2)), atLeast(1));
            script.verify(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray3)), atLeast(1));
            script.verify(() -> Script.encodeToOpN(3), atLeast(1));
        }
    }
    ...
    public void createMultiSigOutputScriptWhenPubkeysSizeGreaterThan16AndPubkeysSizeGreaterThan3AndPubkeysIsNotEmThrowsRuntimeException() {
        ...
        try (MockedStatic<Script> script = mockStatic(Script.class, CALLS_REAL_METHODS)) {
            ...
            byte[] byteArray = new byte[]{};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray))).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray2 = new byte[]{(byte) 2, (byte) 118, (byte) -55, (byte) -28, (byte) 34, (byte) 73, (byte) 9, (byte) -51, (byte) -32, (byte) -56, (byte) -100, (byte) 16, (byte) -55, (byte) -27, (byte) -97, (byte) 125, (byte) -40, (byte) 2, (byte) -8, (byte) 99, (byte) -119, (byte) 14, (byte) -113, (byte) -77, (byte) -95, (byte) 122, (byte) 67, (byte) 80, (byte) 95, (byte) -40, (byte) 127, (byte) 127, (byte) 52};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray2))).thenAnswer((Answer<Void>) invocation -> null);
            thrown.expect(RuntimeException.class);
            thrown.expectCause(isA(byte[].class));
            ECKey eCKey = new ECKey();
            ...
            //Assert statement(s)
            script.verify(() -> Script.encodeToOpN(2), atLeast(2));
            script.verify(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray)), atLeast(1));
            script.verify(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray2)), atLeast(1));
        }
    }
    ...
    public void createMultiSigOutputScriptWhenPubkeysSizeGreaterThan3AndPubkeysIsNotEmptyAndCaughtIOException2ThrowsRuntimeException() {
        ...
        try (MockedStatic<Script> script = mockStatic(Script.class, CALLS_REAL_METHODS)) {
            ...
            byte[] byteArray = new byte[]{};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray))).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray2 = new byte[]{(byte) 2, (byte) -13, (byte) 68, (byte) 113, (byte) 19, (byte) -64, (byte) 54, (byte) 32, (byte) 31, (byte) 85, (byte) 8, (byte) 8, (byte) 106, (byte) -106, (byte) -47, (byte) 106, (byte) -100, (byte) -113, (byte) -5, (byte) -13, (byte) -42, (byte) 120, (byte) -68, (byte) -35, (byte) -36, (byte) -83, (byte) -45, (byte) 16, (byte) -117, (byte) -32, (byte) 38, (byte) 82, (byte) 8};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray2))).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray3 = new byte[]{(byte) 2, (byte) 89, (byte) -17, (byte) -74, (byte) -41, (byte) -62, (byte) 80, (byte) 31, (byte) 54, (byte) 74, (byte) -19, (byte) -125, (byte) 9, (byte) 115, (byte) 83, (byte) 63, (byte) -4, (byte) 66, (byte) 78, (byte) 49, (byte) 16, (byte) -73, (byte) 51, (byte) 22, (byte) -101, (byte) -66, (byte) -5, (byte) 97, (byte) -6, (byte) 74, (byte) 102, (byte) -61, (byte) 36};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray3))).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray4 = new byte[]{(byte) 3, (byte) 99, (byte) -62, (byte) -105, (byte) -15, (byte) -37, (byte) 99, (byte) -83, (byte) -47, (byte) -20, (byte) 41, (byte) 1, (byte) 106, (byte) 74, (byte) 67, (byte) 110, (byte) -5, (byte) 79, (byte) 62, (byte) -112, (byte) 96, (byte) -25, (byte) 45, (byte) 94, (byte) 44, (byte) -111, (byte) 35, (byte) -68, (byte) -8, (byte) 104, (byte) 100, (byte) -40, (byte) 50};
            script.when(() -> Script.writeBytes((ByteArrayOutputStream) any(), eq(byteArray4))).thenAnswer((Answer<Void>) invocation -> null);
            script.when(() -> Script.encodeToOpN(4)).thenReturn(1);
            thrown.expect(RuntimeException.class);
            thrown.expectCause(isA(byte[].class));
    ...
    public void removeAllInstancesOfWhenOpcodeEqualsOP_PUSHDATA2AndSkipIsEmptyAndCaughtIOExceptionThrowsRuntimeException() throws IOException {
        ...
        //Arrange Statement(s)
        thrown.expect(RuntimeException.class);
        thrown.expectCause(isA(int.class));
        byte[] byteArray = new byte[]{(byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5};
        byte[] byteArray2 = new byte[]{(byte) 3, (byte) 4};
        //Act Statement(s)
        Script.removeAllInstancesOf(byteArray, byteArray2);
    ...
    @Test()
    public void executeScriptWhenStackSizePlusAltstackSizeNotLessThan0AndIfStackIsEmpty4() throws ScriptException {
        /* Branches:
         * (for-each(script.chunks)) : true
         * (!ifStack.contains(false)) : true
         * (chunk.data != null) : false
    ...
    public void correctlySpendsWhenCaughtSignatureDecodeException() throws Exception {
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class, CALLS_REAL_METHODS)) {
            ...
            verify(target, atLeast(1)).correctlySpends(eq(transaction), eq(0L), (Script) any(), eq(scriptVerifyFlagSet));
        }
    }
    ...
    @Test()
    public void correctlySpendsWhenScriptPatternIsP2PKHScriptPubKeyAndChunksSizeEquals2AndNotValidSigThrowsScriptException() throws ScriptException {
        /* Branches:
         * (ScriptPattern.isP2WPKH(scriptPubKey)) : false
         * (catch-exception (SignatureDecodeException)) : true
         * (ScriptPattern.isP2PKH(scriptPubKey)) : true
    ...
    @Test()
    public void correctlySpendsWhenScriptPatternIsP2PKHScriptPubKeyAndChunksSizeEquals2AndValidSig() throws ScriptException {
        /* Branches:
         * (ScriptPattern.isP2WPKH(scriptPubKey)) : false
         * (catch-exception (SignatureDecodeException)) : true
         * (ScriptPattern.isP2PKH(scriptPubKey)) : true
    ...
    @Test()
    public void correctlySpendsWhenScriptPatternIsP2PKScriptPubKeyAndChunksSizeEquals1AndNotValidSigThrowsScriptException() throws Exception {
        /* Branches:
         * (ScriptPattern.isP2WPKH(scriptPubKey)) : false
         * (catch-exception (SignatureDecodeException)) : true
         * (ScriptPattern.isP2PKH(scriptPubKey)) : false
