...
public class ScriptBuilderSapientGeneratedJunit4Test {
    ...
    public void smallNum1WhenNumGreaterThan16() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            ScriptBuilder target = new ScriptBuilder(script);
            //Act Statement(s)
            ScriptBuilder result = target.smallNum(0, 0);
            //Assert statement(s)
            assertThat(result, equalTo(target));
    ...
    public void createP2SHOutputScriptTest() {
        ...
        try (MockedStatic<TimeUtils> timeUtils = mockStatic(TimeUtils.class)) {
            //TODO: Needs to return real value
            timeUtils.when(() -> TimeUtils.currentTime()).thenReturn(null);
            byte[] byteArray = new byte[]{(byte) 18, (byte) 52, (byte) 86, (byte) 120, (byte) -102, (byte) -68, (byte) -34, (byte) -16, (byte) 18, (byte) 52, (byte) 86, (byte) 120, (byte) -102, (byte) -68, (byte) -34, (byte) -16, (byte) 18, (byte) 52, (byte) 86, (byte) 120};
            //Act Statement(s)
