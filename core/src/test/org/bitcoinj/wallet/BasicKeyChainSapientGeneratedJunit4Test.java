...
public class BasicKeyChainSapientGeneratedJunit4Test {
    ...
    public void serializeEncryptableItemWhenItemGetEncryptionTypeEqualsProtosWalletEncryptionTypeENCRYPTED_SCRYPT_AES() {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            doReturn(protosKeyBuilderMock2).when(protosKeyBuilderMock).setCreationTimestamp(1703144040920L);
            doReturn(protosKeyBuilderMock3).when(protosKeyBuilderMock).setSecretBytes(byteStringMock);
            ...
            verify(protosKeyBuilderMock).setCreationTimestamp(1703144040920L);
    ...
    public void serializeEncryptableItemWhenItemGetEncryptionTypeNotEqualsProtosWalletEncryptionTypeENCRYPTEThrowsIllegalStateException() {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            protosKey.when(() -> Protos.Key.newBuilder()).thenReturn(protosKeyBuilderMock);
            doReturn(protosKeyBuilderMock2).when(protosKeyBuilderMock).setCreationTimestamp(1703144048188L);
            ...
            doReturn(protosKeyBuilderMock3).when(protosKeyBuilderMock).setEncryptedData(protosEncryptedDataBuilderMock);
            doReturn(protosKeyBuilderMock4).when(protosKeyBuilderMock).setType(Protos.Key.Type.ENCRYPTED_SCRYPT_AES);
            byte[] byteArray = new byte[]{};
            byteString.when(() -> ByteString.copyFrom(byteArray)).thenReturn(byteStringMock);
            ...
            protosKey.verify(() -> Protos.Key.newBuilder(), atLeast(1));
            verify(protosKeyBuilderMock).setCreationTimestamp(1703144048188L);
    ...
    public void serializeEncryptableItemWhenItemGetEncryptedDataIsNullAndSecretIsNotNull() {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            doReturn(byteArray).when(itemMock).getSecretBytes();
            protosKey.when(() -> Protos.Key.newBuilder()).thenReturn(protosKeyBuilderMock);
            doReturn(protosKeyBuilderMock2).when(protosKeyBuilderMock).setCreationTimestamp(1703144038677L);
            ...
            verify(itemMock).getSecretBytes();
            protosKey.verify(() -> Protos.Key.newBuilder(), atLeast(1));
            verify(protosKeyBuilderMock).setCreationTimestamp(1703144038677L);
