...
public class WalletSapientGeneratedJunit4Test {
    ...
    deterministicKey.when(() -> DeterministicKey.deserializeB58(null, "valid_base58_string", networkMock2)).thenReturn(deterministicKeyMock);
    ...
    base58.when(() -> Base58.decodeChecked("valid_base58_string")).thenReturn(byteArray);
    wallet.when(() -> Wallet.fromWatchingKey(networkMock2, deterministicKeyMock, ScriptType.P2PKH)).thenReturn(walletMock);
    Instant instant = Instant.now();
    //Act Statement(s)
    Wallet result = Wallet.fromWatchingKeyB58(networkMock2, "valid_base58_string", instant);
    //Assert statement(s)
    assertThat(result, equalTo(walletMock));
    deterministicKey.verify(() -> DeterministicKey.deserializeB58(null, "valid_base58_string", networkMock2), atLeast(1));
    ...
    base58.verify(() -> Base58.decodeChecked("valid_base58_string"), atLeast(1));
    wallet.verify(() -> Wallet.fromWatchingKey(networkMock2, deterministicKeyMock, ScriptType.P2PKH), atLeast(1));
}*/
    }
    ...
    public void fromSpendingKeyB58WhenHeaderNotEqualsParamsGetBip32HeaderP2WPKHprivThrowsIllegalArgumentException() {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class);
             MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class);
             MockedStatic<DeterministicKey> deterministicKey = mockStatic(DeterministicKey.class)) {
            deterministicKey.when(() -> DeterministicKey.deserializeB58(null, "L4Tn9JtKJzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7", networkMock2)).thenReturn(deterministicKeyMock);
            doNothing().when(deterministicKeyMock).setCreationTime((Instant) any());
            networkParameters.when(() -> NetworkParameters.of(networkMock2)).thenReturn(networkParametersMock);
            doReturn(1).when(networkParametersMock).getBip32HeaderP2PKHpub();
            doReturn(1).when(networkParametersMock).getBip32HeaderP2PKHpriv();
            ...
            byte[] byteArray = new byte[]{(byte) 0};
            base58.when(() -> Base58.decodeChecked("L4Tn9JtKJzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7")).thenReturn(byteArray);
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("L4Tn");
            thrown.expect(IllegalArgumentException.class);
            thrown.expectMessage(illegalArgumentException.getMessage());
            Instant instant = Instant.now();
            //Act Statement(s)
            Wallet.fromSpendingKeyB58(networkMock2, "L4Tn9JtKJzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7", instant);
            //Assert statement(s)
            deterministicKey.verify(() -> DeterministicKey.deserializeB58(null, "L4Tn9JtKJzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7", networkMock2), atLeast(1));
            verify(deterministicKeyMock).setCreationTime((Instant) any());
            networkParameters.verify(() -> NetworkParameters.of(networkMock2), atLeast(1));
            verify(networkParametersMock).getBip32HeaderP2PKHpub();
            verify(networkParametersMock).getBip32HeaderP2PKHpriv();
            verify(networkParametersMock).getBip32HeaderP2WPKHpub();
            verify(networkParametersMock).getBip32HeaderP2WPKHpriv();
            base58.verify(() -> Base58.decodeChecked("L4Tn9JtKJzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7JzJ5J7"), atLeast(1));
        }
    }
    ...
    File file = new File("pathname1");
    //Act Statement(s)
    Wallet result = Wallet.loadFromFile(file, walletProtobufSerializerWalletFactoryMock, true, true, walletExtensionArray);
    //Assert statement(s)
    assertThat(result, equalTo(walletMock));
    ...
    public void connectInputsWhenDefaultBranch2() {
        ...
        try (MockedStatic<StreamUtils> streamUtils = mockStatic(StreamUtils.class)) {
            TransactionOutPoint transactionOutPoint = new TransactionOutPoint(0L, sha256HashMock);
            doReturn(transactionOutPoint).when(utxoMock).getOutPointFor();
            TransactionOutPoint transactionOutPoint2 = new TransactionOutPoint(0L, sha256HashMock2);
            doReturn(transactionOutPoint2).when(inMock).getOutpoint();
