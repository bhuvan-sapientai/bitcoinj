...
public class ByteUtilsSapientGeneratedJunit4Test {
    ...
    public void parseHexTest() {
         ...
         */
        //Act Statement(s)
        //byte[] result = ByteUtils.parseHex("A");
    ...
    preconditions.when(() -> Preconditions.checkArgument(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
    //Act Statement(s)
    byte[] result = ByteUtils.bigIntegerToBytes(new BigInteger("123456789"), 10);
    byte[] byteResultArray = new byte[] { (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 7, (byte) 91, (byte) -51, (byte) 21 };
    //Assert statement(s)
    assertThat(result, equalTo(byteResultArray));
    preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()), atLeast(3));
}*/
    ...
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16LE(5000, byteBuffer);
    ByteOrder byteOrder = ByteOrder.LITTLE_ENDIAN;
    ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
    ByteBuffer byteBuffer3 = byteBuffer2.putShort((short) 5000);
    //Assert statement(s)
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16LE(50000, byteBuffer);
    ByteOrder byteOrder = ByteOrder.LITTLE_ENDIAN;
    ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
    ...
    byteUtils.when(() -> ByteUtils.writeInt16LE(eq(10), (ByteBuffer) any())).thenReturn(null);
    byte[] byteArray = new byte[] {};
    //Act Statement(s)
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16BE(10, byteBuffer);
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16BE(5000, byteBuffer);
    ByteOrder byteOrder = ByteOrder.BIG_ENDIAN;
    ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
    ByteBuffer byteBuffer3 = byteBuffer2.putShort((short) 5000);
    //Assert statement(s)
    ...
    public void writeInt16BE1WhenOffsetGreaterThanOutLengthMinus2() throws Throwable {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS);
            ...
            preconditions.when(() -> Preconditions.check(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
            //TODO: Needs to return real value
            byteUtils.when(() -> ByteUtils.writeInt16BE(eq(1), (ByteBuffer) any())).thenReturn(null);
            byte[] byteArray = new byte[]{(byte) 0, (byte) 0};
            //Act Statement(s)
            ByteUtils.writeInt16BE(1, byteArray, 0);
            //Assert statement(s)
            preconditions.verify(() -> Preconditions.check(eq(false), (Supplier) any()), atLeast(1));
            byteUtils.verify(() -> ByteUtils.writeInt16BE(eq(1), (ByteBuffer) any()), atLeast(1));
        }
    }
    ...
    public void writeInt32LETest() throws BufferOverflowException {
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
        //Act Statement(s)
        ByteBuffer result = ByteUtils.writeInt32LE(12345, byteBuffer);
        ByteOrder byteOrder = ByteOrder.LITTLE_ENDIAN;
        ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
        ByteBuffer byteBuffer3 = byteBuffer2.putInt(12345);
        //Assert statement(s)
        assertThat(result, equalTo(byteBuffer3));
    }
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt32LE(4294967295L, byteBuffer);
    ByteOrder byteOrder = ByteOrder.LITTLE_ENDIAN;
    ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
    ...
    preconditions.when(() -> Preconditions.check(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
    //TODO: Needs to return real value
    byteUtils.when(() -> ByteUtils.writeInt32LE(eq(123456789L), (ByteBuffer) any())).thenReturn(null);
    byte[] byteArray = new byte[] {};
    //Act Statement(s)
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt32BE(4294967295L, byteBuffer);
    ByteOrder byteOrder = ByteOrder.BIG_ENDIAN;
    ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
    ByteBuffer byteBuffer3 = byteBuffer2.putInt(-1);
    //Assert statement(s)
    ...
    public void writeInt32BE1Test() throws BufferOverflowException {
        ...
        //ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
        //Act Statement(s)
        //ByteBuffer result = ByteUtils.writeInt32BE(10, byteBuffer);
        //ByteOrder byteOrder = ByteOrder.BIG_ENDIAN;
        //ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
    ...
    preconditions.when(() -> Preconditions.check(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
    //TODO: Needs to return real value
    byteUtils.when(() -> ByteUtils.writeInt32BE(eq(16909060L), (ByteBuffer) any())).thenReturn(null);
    byte[][] byteArray3 = new byte[][] { (byte) 0, (byte) 0, (byte) 0, (byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5 };
    byte[][] byteArray4 = new byte[][] { (byte) 8 };
    byte[][] byteArray5 = new byte[][] { (byte) 4 };
    byte[][] byteArray6 = new byte[][] { (byte) 4 };
    byte[] byteArray2 = new byte[] { byteArray3, byteArray4, byteArray5, byteArray6 };
    byte[] byteArray7 = new byte[] { (byte) 0 };
    byte[] byteArray = new byte[] { byteArray2, byteArray7 };
    //Act Statement(s)
    ByteUtils.writeInt32BE(16909060L, byteArray, 4);
    //Assert statement(s)
    preconditions.verify(() -> Preconditions.check(eq(false), (Supplier) any()), atLeast(1));
    byteUtils.verify(() -> ByteUtils.writeInt32BE(eq(16909060L), (ByteBuffer) any()), atLeast(1));
}*/
    }
    ...
    public void writeInt64LE1WhenOffsetGreaterThanOutLengthPlus8() throws Throwable {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            preconditions.when(() -> Preconditions.check(eq(false), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray = new byte[]{(byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 7, (byte) -91, (byte) 91, (byte) 7, (byte) 0, (byte) 0, (byte) 0};
            //Act Statement(s)
            ByteUtils.writeInt64LE(1234567890L, byteArray, 8);
            //Assert statement(s)
            preconditions.verify(() -> Preconditions.check(eq(false), (Supplier) any()));
        }
    }
    ...
    public void writeInt64LE3WhenBytesLengthGreaterThan8ThrowsRuntimeException() throws IOException {
        ...
        OutputStream outputStream = OutputStream.nullOutputStream();
        //Act Statement(s)
        ByteUtils.writeInt64LE(new BigInteger("18446744073709551617"), outputStream);
    }
    ...
    public void writeInt64LE3WhenILessThan8MinusBytesLength() throws IOException {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS)) {
            byte[] byteArray = new byte[]{};
            byte[] byteArray2 = new byte[]{(byte) 127, (byte) -1, (byte) -1, (byte) -1, (byte) -1, (byte) -1, (byte) -1, (byte) -1};
            byteUtils.when(() -> ByteUtils.reverseBytes(byteArray2)).thenReturn(byteArray);
            OutputStream outputStream = OutputStream.nullOutputStream();
            //Act Statement(s)
            ByteUtils.writeInt64LE(new BigInteger("9223372036854775807"), outputStream);
            //Assert statement(s)
    ...
    public void decodeMPIWhenBufLengthEquals0() {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS)) {
            byte[] byteArray = new byte[]{};
            byteUtils.when(() -> ByteUtils.readUint32BE(byteArray, 0)).thenReturn(8L);
            //Act Statement(s)
    ...
    public void encodeMPIWhenLengthNotEqualsArrayLengthAndIsNegative() {
         ...
         */
        //Act Statement(s)
        byte[] result = ByteUtils.encodeMPI(new BigInteger("-10"), false);
        byte[] byteResultArray = new byte[]{(byte) -118};
        //Assert statement(s)
        assertThat(result, equalTo(byteResultArray));
    }
    ...
    public void encodeMPIWhenLengthEqualsArrayLengthAndNotIsNegative() {
         ...
         */
        //Act Statement(s)
        byte[] result = ByteUtils.encodeMPI(new BigInteger("1234567890"), false);
    ...
    public void encodeCompactBitsWhenValueSignumEqualsMinus1() {
         ...
         */
        //Act Statement(s)
        long result = ByteUtils.encodeCompactBits(new BigInteger("-1000"));
        //Assert statement(s)
        assertThat(result, equalTo(-1000L));
    }

    //Sapient generated method id: ${acfa0d38-b259-3864-99bc-fe723b737da0}
    @Test()
    public void encodeCompactBitsWhenResultAnd0x00800000LEquals0AndValueSignumNotEqualsMinus1() {
        /* Branches:
         * (size <= 3) : false
         * ((result & 0x00800000L) != 0) : false
         * (value.signum() == -1) : false
         */
        //Act Statement(s)
        long result = ByteUtils.encodeCompactBits(new BigInteger("1000"));
        //Assert statement(s)
        assertThat(result, equalTo(33810432L));
    }
