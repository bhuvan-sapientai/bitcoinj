...
public class MissingSigResolutionSignerSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${f340c579-9bbd-36cd-bf14-09059bcfa900}, hash: 4DE1862828543ADD07F90EA0EEFA7A91
    @Test()
    ...
    //Sapient generated method id: ${48e662be-97d5-3c97-a7b9-8572cbc66ecb}, hash: 9E51ADE2FC1D09E06A679CE0CDD2DCD6
    @Test()
    ...
    //Sapient generated method id: ${629f61eb-ce4b-38c3-b66e-727ae00974c2}, hash: 75E55FB806627176508046142EB93F80
    @Test()
    ...
    //Sapient generated method id: ${50a6b179-2cb2-315d-82b7-4c781026abf7}, hash: 1B0DCA04DD3F74C73F6114C1D27D65F5
    @Ignore()
    @Test()
    public void signInputsWhenScriptPatternNotIsP2WPKHScriptPubKeyThrowsIllegalStateException() throws ScriptException {
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class)) {
            doReturn(transactionInputMock).when(partialTxMock).getInput(0L);
            doReturn(transactionOutputMock, transactionOutputMock2).when(transactionInputMock).getConnectedOutput();
            doReturn(scriptMock).when(transactionOutputMock2).getScriptPubKey();
            doReturn(scriptMock2).when(transactionInputMock).getScriptSig();
            ...
            //Assert statement(s)
            verify(partialTxMock).getInput(0L);
            verify(transactionInputMock, times(2)).getConnectedOutput();
            verify(transactionOutputMock2).getScriptPubKey();
            verify(transactionInputMock).getScriptSig();
    ...
    //Sapient generated method id: ${71c92121-a44a-3eb6-9001-047798f780bb}, hash: 98E3CA9247E00F7C32B9B87CB572DF2C
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${8905dab8-a6cc-3c0d-8eaa-074ef6a55557}, hash: 77D2299E229985FBD9AAC4A9C35C9FC8
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${b3b3a5ea-cfd6-3063-ba38-9d51bac03af4}, hash: B069BB64A82B65086FE35B1F6DAEF523
    @Test()
    ...
    //Sapient generated method id: ${6ce799e7-c1f3-3a63-ace2-57e6e73eba22}, hash: 31A41AD8D921A8C9E3B8919C0AD0A027
    @Test()
    ...
    //Sapient generated method id: ${d539a172-077b-3f91-a7a2-bc61068d5195}, hash: A5CCBCFB3D19B86E9C99793C7FDDC064
    @Ignore()
    @Test()
    public void signInputsWhenTxInGetWitnessGetPush0LengthEquals0AndMissingSigsModeEqualsWalletMisThrowsECKeyMissingPrivateKeyException() throws ScriptException {
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class)) {
            ...
            doReturn(scriptMock).when(transactionOutputMock2).getScriptPubKey();
            doReturn(scriptMock2).when(transactionInputMock).getScriptSig();
            doReturn(transactionWitnessMock, transactionWitnessMock2, transactionWitnessMock3).when(transactionInputMock).getWitness();
            ...
            verify(transactionOutputMock2).getScriptPubKey();
            verify(transactionInputMock).getScriptSig();
            verify(transactionInputMock, times(3)).getWitness();
    ...
    //Sapient generated method id: ${311e8ef9-ad4a-3577-be65-6c029b670d42}, hash: B63A66CCF6D95D50D934134F368B8B77
    @Test()
    public void signInputsWhenMissingSigsModeNotEqualsWalletMissingSigsModeTHROWAndMissingSigsModeEqualsWalletMissingSigsModeUSE_DUMMY_8() throws ScriptException {
        ...
        try (MockedStatic<TransactionWitness> transactionWitness = mockStatic(TransactionWitness.class);
            ...
            byte[] byteArray = new byte[]{};
            doReturn(byteArray).when(transactionWitnessMock3).getPush(0);
            doNothing().when(transactionInputMock2).setWitness(transactionWitnessMock4);
            byte[] byteArray2 = new byte[]{};
            doReturn(eCKeyMock).when(keyBagMock).findKeyFromPubKeyHash(byteArray2, ScriptType.P2WPKH);
            scriptPattern.when(() -> ScriptPattern.isP2SH(scriptMock)).thenReturn(false);
            scriptPattern.when(() -> ScriptPattern.isSentToMultisig(scriptMock)).thenReturn(false);
            scriptPattern.when(() -> ScriptPattern.isP2PK(scriptMock)).thenReturn(false);
            scriptPattern.when(() -> ScriptPattern.isP2PKH(scriptMock)).thenReturn(false);
            scriptPattern.when(() -> ScriptPattern.isP2WPKH(scriptMock)).thenReturn(true);
            scriptPattern.when(() -> ScriptPattern.extractHashFromP2WH(scriptMock)).thenReturn(byteArray2);
            transactionWitness.when(() -> TransactionWitness.redeemP2WPKH((TransactionSignature) any(), eq(eCKeyMock))).thenReturn(transactionWitnessMock4);
            MissingSigResolutionSigner target = new MissingSigResolutionSigner(Wallet.MissingSigsMode.USE_DUMMY_SIG);
            TransactionSigner.ProposedTransaction transactionSignerProposedTransaction = new TransactionSigner.ProposedTransaction(partialTxMock);
            //Act Statement(s)
            boolean result = target.signInputs(transactionSignerProposedTransaction, keyBagMock);
            ...
            verify(transactionWitnessMock3).getPush(0);
            verify(transactionInputMock2).setWitness(transactionWitnessMock4);
            verify(keyBagMock).findKeyFromPubKeyHash(byteArray2, ScriptType.P2WPKH);
            scriptPattern.verify(() -> ScriptPattern.isP2SH(scriptMock), atLeast(1));
            scriptPattern.verify(() -> ScriptPattern.isSentToMultisig(scriptMock), atLeast(1));
            scriptPattern.verify(() -> ScriptPattern.isP2PK(scriptMock), atLeast(1));
            scriptPattern.verify(() -> ScriptPattern.isP2PKH(scriptMock), atLeast(1));
