...
public class MultiplexingDiscoverySapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${898aacca-031f-3e9c-bf3d-68650c274db7}
    @Test()
    ...
    //Sapient generated method id: ${38163baf-b63c-3b9b-b185-05ec350b48a6}
    @Test()
    ...
    public void getPeersWhenParallelQueriesAndAddrsSizeEquals0ThrowsPeerDiscoveryException() throws PeerDiscoveryException {
        ...
        //Arrange Statement(s)
        Network networkMock = mock(Network.class);
        PeerDiscovery peerDiscoveryMock = mock(PeerDiscovery.class, "Bitcoin");
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            ...
            target = spy(new MultiplexingDiscovery(networkMock, peerDiscoveryList));
            ...
            //Act Statement(s)
            target.getPeers(1234567890L, duration);
            //Assert statement(s)
            networkParameters.verify(() -> NetworkParameters.of(networkMock), atLeast(1));
    ...
    @Ignore(value = "Potential harmful system call (Future.isCancelled) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests")
    @Test()
    public void getPeersWhenParallelQueriesAndCaughtExecutionExceptionAndAddrsSizeEquals0ThrowsPeerDiscoveryException() throws PeerDiscoveryException, InterruptedException {
        ...
        //Arrange Statement(s)
        Network networkMock = mock(Network.class);
        PeerDiscovery peerDiscoveryMock = mock(PeerDiscovery.class, "seed1");
        PeerDiscovery peerDiscoveryMock2 = mock(PeerDiscovery.class, "seed2");
        PeerDiscovery peerDiscoveryMock3 = mock(PeerDiscovery.class, "seed3");
        Future futureMock = mock(Future.class, "List<Future<Object>>");
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            NetworkParameters networkParameters2 = NetworkParameters.fromID("id1");
            networkParameters.when(() -> NetworkParameters.of(networkMock)).thenReturn(networkParameters2);
            List<PeerDiscovery> peerDiscoveryList = new ArrayList<>();
            ...
            futureListInetSocketAddressList.add(futureMock);
    ...
    public void getPeersWhenCaughtExecutionExceptionAndParallelQueriesAndAddrsSizeEquals0ThrowsPeerDiscoveryException() throws PeerDiscoveryException, InterruptedException {
        ...
        //Arrange Statement(s)
        Network networkMock = mock(Network.class);
        PeerDiscovery peerDiscoveryMock = mock(PeerDiscovery.class, "List<Future<Object>>");
        Future futureMock = mock(Future.class, "List<Future<Object>>");
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            NetworkParameters networkParameters2 = NetworkParameters.fromID("id1");
            networkParameters.when(() -> NetworkParameters.of(networkMock)).thenReturn(networkParameters2);
    ...
    public void createExecutorTest() {
        ...
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            ...
            List<PeerDiscovery> peerDiscoveryList = new ArrayList<>();
            peerDiscoveryList.add(peerDiscoveryMock);
            target = new MultiplexingDiscovery(networkMock, peerDiscoveryList);
            autoCloseableMocks = MockitoAnnotations.openMocks(this);
            //Act Statement(s)
