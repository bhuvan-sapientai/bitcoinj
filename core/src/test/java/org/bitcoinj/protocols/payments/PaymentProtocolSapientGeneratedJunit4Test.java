...
public class PaymentProtocolSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${3d326811-bae6-330e-97be-cfc2283f207d}, hash: 7F4B977B4140352129845ABD677AC028
    @Test()
    public void createPaymentRequestTest() {
        ...
        try (MockedStatic<PaymentProtocol> paymentProtocol = mockStatic(PaymentProtocol.class, CALLS_REAL_METHODS)) {
            paymentProtocol.when(() -> PaymentProtocol.createPayToAddressOutput(coinMock, addressMock)).thenReturn(protosOutputMock);
    ...
    //Sapient generated method id: ${facb57f4-41e0-34d7-987e-22c3347a27a8}, hash: 47DC588FEDD2AC853EE87C318366348B
    @Ignore()
    @Test()
    public void createPaymentRequest1WhenMerchantDataIsNotNull() {
        ...
        try (MockedStatic<Protos.PaymentRequest> protosPaymentRequest = mockStatic(Protos.PaymentRequest.class);
            ...
            doReturn(protosPaymentDetailsBuilderMock6).when(protosPaymentDetailsBuilderMock).setTime(1712214063L);
            ...
            verify(protosPaymentDetailsBuilderMock, atLeast(1)).setTime(1712214063L);
    ...
    //Sapient generated method id: ${2d93a84e-04b7-301b-a1cd-7f3dd583fd50}, hash: 865EA91AE31156F4D89040D239F1D95F
    @Ignore()
    @Test()
    public void parsePaymentRequestTest() throws PaymentProtocolException {
        /*
         * TODO: Help needed! This method is not unit testable!
         *  No constructor found to create an object without any exception for class org.bitcoinj.protocols.payments.PaymentSession
         *  Suggestions:
        ...
        //Assert statement(s)
        //TODO: Please implement equals method in PaymentSession for verification of the entire object or you need to adjust respective assertion statements
        assertThat(result, is(notNullValue()));
    }

    //Sapient generated method id: ${57e48229-ddb6-3265-8c1e-1d72573d6b7c}, hash: 54EE29CB903D0E0ADA9C3287E3F1F42B
    @Ignore()
    @Test()
    public void signPaymentRequestWhenRSAEqualsIgnoreCasePrivateKeyGetAlgorithm() throws GeneralSecurityException {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  Following variables could not be isolated/mocked: signature
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            doReturn(protosPaymentRequestBuilderMock3).when(paymentRequestMock).setSignature(byteString3);
            ...
            X509Certificate[] x509CertificateArray = new X509Certificate[]{x509CertificateMock};
            //Act Statement(s)
            PaymentProtocol.signPaymentRequest(paymentRequestMock, x509CertificateArray, privateKeyMock);
            //Assert statement(s)
            verify(paymentRequestMock).setPkiType("x509+sha256");
            verify(paymentRequestMock).setPkiData((ByteString) any());
            verify(paymentRequestMock).setSignature(byteString3);
    ...
    //Sapient generated method id: ${e26efa18-d160-36c5-b1a0-e100eef79062}, hash: 8E503E04F7AF31FA20F23F8B46BAE3B5
    @Ignore()
    @Test()
    public void signPaymentRequestWhenRSANotEqualsIgnoreCasePrivateKeyGetAlgorithmThrowsIllegalStateException() throws CertificateEncodingException {
        /* Branches:
         * (for-each(certificateChain)) : true
         * ("RSA".equalsIgnoreCase(privateKey.getAlgorithm())) : false
         */
        //Arrange Statement(s)
        Protos.PaymentRequest.Builder paymentRequestMock = mock(Protos.PaymentRequest.Builder.class, "GeneratedMessageLite");
        PrivateKey privateKeyMock = mock(PrivateKey.class, "PrivateKey");
        ByteString byteStringMock2 = mock(ByteString.class, "ByteString");
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
             MockedStatic<Protos.X509Certificates> protosX509Certificates = mockStatic(Protos.X509Certificates.class)) {
            doReturn(protosPaymentRequestBuilderMock).when(paymentRequestMock).setPkiType("x509+sha256");
            doReturn(protosPaymentRequestBuilderMock2).when(paymentRequestMock).setPkiData(byteStringMock);
            ByteString byteString2 = ByteString.EMPTY;
            doReturn(protosPaymentRequestBuilderMock3).when(paymentRequestMock).setSignature(byteString2);
            doReturn(protosPaymentRequestMock).when(paymentRequestMock).build();
            doReturn(null).when(privateKeyMock).getAlgorithm();
            protosX509Certificates.when(() -> Protos.X509Certificates.newBuilder()).thenReturn(protosX509CertificatesBuilderMock);
            doReturn(protosX509CertificatesBuilderMock2).when(protosX509CertificatesBuilderMock).addCertificate(byteStringMock2);
            doReturn(protosX509CertificatesMock).when(protosX509CertificatesBuilderMock).build();
            doReturn(byteStringMock).when(protosX509CertificatesMock).toByteString();
            byte[] byteArray = new byte[]{};
            byteString.when(() -> ByteString.copyFrom(byteArray)).thenReturn(byteStringMock2);
            IllegalStateException illegalStateException = new IllegalStateException((String) null);
            ...
            //Assert statement(s)
            verify(paymentRequestMock).setPkiType("x509+sha256");
            verify(paymentRequestMock).setPkiData(byteStringMock);
            verify(paymentRequestMock).setSignature(byteString2);
            verify(paymentRequestMock).build();
            verify(privateKeyMock, times(2)).getAlgorithm();
            protosX509Certificates.verify(() -> Protos.X509Certificates.newBuilder(), atLeast(1));
            verify(protosX509CertificatesBuilderMock).addCertificate(byteStringMock2);
            verify(protosX509CertificatesBuilderMock).build();
            verify(protosX509CertificatesMock).toByteString();
            byteString.verify(() -> ByteString.copyFrom(byteArray), atLeast(1));
        }
    }

    //Sapient generated method id: ${0c90fcb3-e444-33da-9220-8976c86d742b}, hash: 7450B4DCFA92A12F5345B08AFBD8CCCA
    @Ignore()
    @Test()
    public void signPaymentRequestWhenCaughtGeneralSecurityExceptionThrowsRuntimeException() throws CertificateEncodingException, InvalidKeyException, SignatureException, NoSuchAlgorithmException {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            doReturn(protosPaymentRequestBuilderMock4).when(paymentRequestMock).setSignature(byteStringMock);
            byte[] byteArray2 = new byte[]{};
            doReturn(byteArray2).when(certificateMock).getEncoded();
            protosX509Certificates.when(() -> Protos.X509Certificates.newBuilder()).thenReturn(protosX509CertificatesBuilderMock);
            doReturn(protosX509CertificatesBuilderMock2).when(protosX509CertificatesBuilderMock).addCertificate(byteStringMock2);
            Protos.X509Certificates x509Certificates = (Protos.X509Certificates) protosX509CertificatesBuilderMock.build();
            doReturn(x509Certificates).when(protosX509CertificatesBuilderMock).build();
            byteString.when(() -> ByteString.copyFrom(byteArray2)).thenReturn(byteStringMock2);
            signature.when(() -> Signature.getInstance("SHA256withRSA")).thenReturn(signatureMock);
            doNothing().when(signatureMock).initSign(privateKeyMock);
            doNothing().when(signatureMock).update(byteArray);
            byte[] byteArray3 = new byte[]{};
            doReturn(byteArray3).when(signatureMock).sign();
            byteString.when(() -> ByteString.copyFrom(byteArray3)).thenReturn(byteStringMock);
            thrown.expect(RuntimeException.class);
            thrown.expectCause(is(instanceOf(GeneralSecurityException.class)));
            X509Certificate[] x509CertificateArray = new X509Certificate[]{certificateMock};
            //Act Statement(s)
            PaymentProtocol.signPaymentRequest(paymentRequestMock, x509CertificateArray, privateKeyMock);
            //Assert statement(s)
            verify(paymentRequestMock).setPkiType("x509+sha256");
            ...
            verify(protosPaymentRequestMock).toByteArray();
            verify(paymentRequestMock).setSignature(byteStringMock);
            verify(certificateMock).getEncoded();
            protosX509Certificates.verify(() -> Protos.X509Certificates.newBuilder(), atLeast(1));
            verify(protosX509CertificatesBuilderMock).addCertificate(byteStringMock2);
            verify(protosX509CertificatesBuilderMock).build();
            byteString.verify(() -> ByteString.copyFrom(byteArray2), atLeast(1));
            signature.verify(() -> Signature.getInstance("SHA256withRSA"), atLeast(1));
            verify(signatureMock).initSign(privateKeyMock);
            verify(signatureMock).update(byteArray);
            verify(signatureMock).sign();
            byteString.verify(() -> ByteString.copyFrom(byteArray3), atLeast(1));
        }
    }

    //Sapient generated method id: ${d88892d4-0bf9-3f3b-8639-5118cc7e9db7}, hash: F84B533DDD9B667F1599B7D8FDFDA7D4
    @Test()
    public void verifyPaymentRequestPkiWhenNoneEqualsPkiType() throws PaymentProtocolException, InvalidProtocolBufferException, SignatureException, NoSuchAlgorithmException, InvalidKeyException, CertificateException, KeyStoreException, CertPathValidatorException, InvalidAlgorithmParameterException {
        ...
        //Act Statement(s)
        PaymentProtocol.PkiVerificationData result = PaymentProtocol.verifyPaymentRequestPki(paymentRequestMock, keyStoreMock);
        //Assert statement(s)
        assertThat(result, is(nullValue()));
        verify(paymentRequestMock).getPkiType();
    }

    //Sapient generated method id: ${13c90664-adaa-3c87-906c-12e676c59af3}, hash: 19EAB83E226BE6F8054639626827D94D
    @Ignore()
    @Test()
    public void verifyPaymentRequestPkiWhenCaughtCertificateExceptionOrSignatureEThrowsPaymentProtocolExceptionPkiVerificationException() throws PaymentProtocolException {
        ...
        //Act Statement(s)
        PaymentProtocol.verifyPaymentRequestPki(paymentRequestMock, keyStoreMock);
        //Assert statement(s)
        verify(paymentRequestMock).getPkiType();
    }

    //Sapient generated method id: ${b01f2889-7f3f-3725-a054-68e3897478fe}, hash: 41E410C3C4145156B4309DAC82A0C517
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${f54cfa5e-ab54-36bb-8a7f-54177b959b36}, hash: FCCC9C49C2F69434BF2EEA51D5DC67D0
    @Test()
    ...
    //Sapient generated method id: ${8a1b68a5-e7c6-3618-b0f0-6a740be54561}, hash: 378CF584518405C300EA4A8B2F92112E
    @Test()
    ...
    //Sapient generated method id: ${6b94a25c-1be9-369b-ba74-f5d47bb566fc}, hash: E25769929DEF27809D7A487E5BF45434
    @Test()
    public void verifyPaymentRequestPkiWhenSignatureNotVerifyPaymentRequestGetSigThrowsPaymentProtocolExceptionPkiVerificationException() throws PaymentProtocolException, InvalidProtocolBufferException {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  Following variables could not be isolated/mocked: result, signature, validator, certificateFactory, params
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
    ...
    //Sapient generated method id: ${8f2d6f33-06b6-318b-b175-e01a4957d7d4}, hash: 80974E64DD21820C0F8CE28DFB33EE25
    @Test()
    ...
    //Sapient generated method id: ${85c163a3-c732-31c6-b407-e2178571cfa1}, hash: DD445E4A6022C49D29A631BB6CE9CC96
    @Ignore()
    @Test()
    public void verifyPaymentRequestPkiWhenDisplayNameIsNotNullAndCaughtInvalidProtocolBuffThrowsPaymentProtocolExceptionInvalidPkiData() throws PaymentProtocolException, CertificateException, CertPathValidatorException, InvalidAlgorithmParameterException, InvalidKeyException, SignatureException, KeyStoreException, InvalidProtocolBufferException, NoSuchAlgorithmException {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  Following variables could not be isolated/mocked: params
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
         */
        //Arrange Statement(s)
        CertificateFactory certificateFactoryMock = mock(CertificateFactory.class);
        CertPath certPathMock = mock(CertPath.class);
        CertPathValidator certPathValidatorMock = mock(CertPathValidator.class);
        PKIXCertPathValidatorResult pKIXCertPathValidatorResultMock = mock(PKIXCertPathValidatorResult.class);
        ...
        try (MockedStatic<X509Utils> x509Utils = mockStatic(X509Utils.class);
            ...
            doReturn(byteStringList).when(protosX509CertificatesMock).getCertificateList();
            doReturn(null).when(byteString2Mock).newInput();
            certificateFactory.when(() -> CertificateFactory.getInstance("X.509")).thenReturn(certificateFactoryMock);
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            InputStream inputStream = new ByteArrayInputStream(byteArrayOutputStream.toByteArray());
            doReturn(x509CertificateMock).when(certificateFactoryMock).generateCertificate(inputStream);
            List<Certificate> anyList = new ArrayList<>();
            anyList.add(x509CertificateMock);
            doReturn(certPathMock).when(certificateFactoryMock).generateCertPath(anyList);
            certPathValidator.when(() -> CertPathValidator.getInstance("PKIX")).thenReturn(certPathValidatorMock);
            doReturn(pKIXCertPathValidatorResultMock).when(certPathValidatorMock).validate(eq(certPathMock), (CertPathParameters) any());
            signature.when(() -> Signature.getInstance("SHA256withRSA")).thenReturn(signatureMock);
            doNothing().when(signatureMock).initVerify(publicKeyMock);
            doNothing().when(signatureMock).update(byteArray);
            doReturn(true).when(signatureMock).verify(byteArray2);
            x509Utils.when(() -> X509Utils.getDisplayNameFromCertificate(x509CertificateMock, true)).thenReturn("return_of_getDisplayNameFromCertificate1");
            thrown.expect(PaymentProtocolException.InvalidPkiData.class);
            //Act Statement(s)
            PaymentProtocol.verifyPaymentRequestPki(paymentRequestMock, keyStoreMock);
            //Assert statement(s)
            ...
            verify(certificateFactoryMock).generateCertificate(inputStream);
            verify(certificateFactoryMock).generateCertPath(anyList);
            certPathValidator.verify(() -> CertPathValidator.getInstance("PKIX"), atLeast(1));
            verify(certPathValidatorMock).validate(eq(certPathMock), (CertPathParameters) any());
            signature.verify(() -> Signature.getInstance("SHA256withRSA"), atLeast(1));
            verify(signatureMock).initVerify(publicKeyMock);
            verify(signatureMock).update(byteArray);
            verify(signatureMock).verify(byteArray2);
            x509Utils.verify(() -> X509Utils.getDisplayNameFromCertificate(x509CertificateMock, true), atLeast(1));
        }
    }

    //Sapient generated method id: ${f0f7fadc-3bc3-3edd-85a1-9fbad1d24630}, hash: 785DCBBEC369F346DA2D877D02664AA1
    @Ignore()
    @Test()
    public void verifyPaymentRequestPkiWhenSignatureVerifyPaymentRequestGetSignatureToByteArrayAndDisplayNameIsNotNull() throws PaymentProtocolException, PkiVerificationException, InvalidProtocolBufferException, SignatureException, NoSuchAlgorithmException, InvalidKeyException, CertificateException, KeyStoreException, CertPathValidatorException, InvalidAlgorithmParameterException {
        /* Branches:
         * ("none".equals(pkiType)) : false
         * ("x509+sha256".equals(pkiType)) : false
    ...
    //Sapient generated method id: ${a5de3777-890b-3d0c-b7ae-77989f769566}, hash: 464F18C48464FE570F98CB95B6A82F13
    @Test()
    ...
    //Sapient generated method id: ${1b129479-a34d-333f-b466-c80457f2d5cb}, hash: 800F7CFDD07B361EC27D202BC2F1BAE8
    @Test()
    ...
    //Sapient generated method id: ${e9ee867d-053a-3dfc-a726-be1432f43f6c}, hash: 3E2F9109C309C14F2C3CA7D7769A3F51
    @Test()
    ...
    //Sapient generated method id: ${e55007f8-66a1-3dfe-955b-77cffb0366ba}, hash: FB51DA1F56458AC172102397E63944CB
    @Ignore()
    @Test()
    public void createPaymentMessage1WhenRefundOutputsIsNotEmptyAndMemoIsNotNullAndMerchantDataIsNotNull() {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            Protos.Payment.Builder builder2 = protosPaymentBuilderMock.setMerchantData(byteString3);
            ...
            assertThat(transactionList.get(0), is(instanceOf(Transaction.class)));
            verify(transactionMock).serialize();
            protosPayment.verify(() -> Protos.Payment.newBuilder(), atLeast(1));
            verify(protosPaymentBuilderMock, atLeast(1)).addTransactions(byteStringMock);
            verify(protosPaymentBuilderMock, atLeast(1)).addRefundTo(protosOutputMock);
            verify(protosPaymentBuilderMock, atLeast(1)).setMemo("memo1");
            verify(protosPaymentBuilderMock).setMerchantData((ByteString) any());
            verify(protosPaymentBuilderMock, atLeast(1)).build();
            byteString.verify(() -> ByteString.copyFrom(byteArray), atLeast(1));
            byteString.verify(() -> ByteString.copyFrom(byteArray2), atLeast(1));
        }
    }

    //Sapient generated method id: ${d59546f7-2ecd-3fc4-ba76-0186a14d37d1}, hash: 4EFC3201ABB4105AF609FCA640D85669
    @Test()
    public void parseTransactionsFromPaymentMessageWhenPaymentMessageGetTransactionsListIsNotEmpty() throws ProtocolException, UnsupportedOperationException {
        ...
        assertThat(result.get(0), is(instanceOf(Transaction.class)));
    ...
    //Sapient generated method id: ${26f627f9-b53f-3fad-b031-7a778af0d7c5}, hash: 1FC74B2157737D6F1E7C892378BB6485
    @Test()
    ...
    //Sapient generated method id: ${cf01a93f-900d-37d4-843c-9168b63ac7b1}, hash: AD27EF2E65D261B7DD488F61C8CA2173
    @Test()
    public void parsePaymentAckWhenPaymentAckHasMemo() {
        ...
        //Assert statement(s)
        //TODO: Please implement equals method in Ack for verification of the entire object or you need to adjust respective assertion statements
        assertThat(result, is(notNullValue()));
        verify(paymentAckMock).hasMemo();
        verify(paymentAckMock).getMemo();
    }

    //Sapient generated method id: ${67d6ef03-d28f-3150-9321-85ea810ac766}, hash: E027C5349D82C0857B271B5FBBD0BBF1
    @Test()
    ...
    //Sapient generated method id: ${3f2d4c49-693e-345a-a2f9-a97605644fed}, hash: 3A8AC3ADBBF2FD161A157E914266C793
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${db8ac907-0629-37e3-b302-a7ed8f5c5daf}, hash: 05A43391AA5C4B24D868874F9F2181BD
    @Test()
    ...
    //Sapient generated method id: ${f4a78796-6cec-3423-bb7b-e7d5127aefff}, hash: 5A1CD0D33BB8674D70D3EE3D6D8D608E
    @Ignore()
    @Test()
    public void createPayToAddressOutputWhenParamsNetworkNotExceedsMaxMoneyAmount() {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            networkParameters.when(() -> NetworkParameters.of(networkMock)).thenReturn(networkParametersMock);
            doReturn(networkMock2).when(networkParametersMock).network();
            doReturn(false).when(networkMock2).exceedsMaxMoney((Monetary) any());
            scriptBuilder.when(() -> ScriptBuilder.createOutputScript(addressMock)).thenReturn(scriptMock);
            byte[] byteArray = new byte[]{};
            doReturn(byteArray).when(scriptMock).program();
            byteString.when(() -> ByteString.copyFrom(byteArray)).thenReturn(byteStringMock);
            ...
            networkParameters.verify(() -> NetworkParameters.of(networkMock), atLeast(1));
            verify(networkParametersMock).network();
            verify(networkMock2).exceedsMaxMoney((Monetary) any());
            scriptBuilder.verify(() -> ScriptBuilder.createOutputScript(addressMock), atLeast(1));
            verify(scriptMock).program();
            byteString.verify(() -> ByteString.copyFrom(byteArray), atLeast(1));
        }
    ...
    //Sapient generated method id: ${f1234942-ea05-34aa-b30a-9a99c062f7b3}, hash: 5552F2F5527B8E45D1A26C7BC08A2EF6
    @Test()
    ...
    //Sapient generated method id: ${2606a65e-f7c3-32d2-92cf-2c161781a5b2}, hash: B893751354B5B286B442739C50758DE3
    @Test()
    ...
    //Sapient generated method id: ${f78b31b4-42a4-3c3b-9c35-ac423213adc4}, hash: 2963954D39D5A88C6BD19F04FC8F770F
    @Test()
    ...
    //Sapient generated method id: ${681c8a63-31cf-3d13-8aeb-ab125766cd48}, hash: D353ABD462954D958CA7DAD2325F54F4
    @Test()
    ...
    //Sapient generated method id: ${9af0dde0-2eec-3bc2-9f8e-cd63f124cd65}, hash: BE0075247E5FAC7673B7CF219FCD12EA
    @Test()
    ...
    //Sapient generated method id: ${15613578-db88-3ad7-adc8-5b3d7b23c730}, hash: AB376C4A55F3CC0B7459F9C4884C11C8
    @Test()
    ...
    //Sapient generated method id: ${555df352-a2ec-356e-82a8-7fe1a4808e11}, hash: 7672DC8A56B8024DFA75E9A9218C87B6
    @Test()
    ...
    //Sapient generated method id: ${ebb21ed6-369a-3420-92d8-859a54a7e2f8}, hash: 2B75CA0BBB1D9511A53CA9EFA6E15B12
    @Test()
    ...
    //Sapient generated method id: ${d60bdbba-1fe2-304f-8a23-957b71e6cf17}, hash: D5A0E1A4D64FC177BCE5D031A8DE552A
    @Test()
    ...
    //Sapient generated method id: ${275153a5-d740-3f2f-b2de-89048f821c1f}, hash: ABB5816FA44815E80BDDBD4169123CE7
    @Test()
    ...
    //Sapient generated method id: ${38455069-974e-314f-bac0-1ff72274eca9}, hash: CF32A4BF2DA8D506F407EF6E1751EC58
    @Test()
    ...
    //Sapient generated method id: ${8dbd3968-1837-36b3-a216-82c842152e31}, hash: 53FAD0551000101E7D8818C0A9C0ED04
    @Test()
