...
public class PaymentSessionSapientGeneratedJunit4Test {
    ...
    public void getMemoWhenPaymentDetailsHasMemo() throws PaymentProtocolException {
        ...
        //doReturn("").when(paymentDetailsMock2).getMemo();
        //Act Statement(s)
    ...
    @Test()
    public void expiresWhenPaymentDetailsNotHasExpires() throws PaymentProtocolException {
        /* Branches:
    ...
    @Ignore()
    @Test()
    public void getSendRequestWhenPaymentDetailsGetOutputsListIsNotEmpty() throws PaymentProtocolException {
        /* Branches:
         * (for-each(paymentDetails.getOutputsList())) : true
         *
         * TODO: Help needed! Please adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
    ...
    listenableCompletableFuture.when(() -> ListenableCompletableFuture.failedFuture(protosPaymentDetailsBuilderMock3)).thenReturn(listenableCompletableFuture2);
    ...
    paymentProtocol.verify(() -> PaymentProtocol.paramsFromPmtProtocolID("return_of_getNetwork1"), atLeast(1));
    paymentProtocol.verify(() -> PaymentProtocol.verifyPaymentRequestPki(requestMock, (KeyStore) null), atLeast(1));
    listenableCompletableFuture.verify(() -> ListenableCompletableFuture.failedFuture(protosPaymentDetailsBuilderMock3), atLeast(1));
    verify(protosPaymentDetailsMock).hasNetwork();
    ...
    public void sendPaymentWhenIsExpiredNot() throws IOException, PaymentProtocolException {
        ...
        try (MockedStatic<ListenableCompletableFuture> listenableCompletableFuture = mockStatic(ListenableCompletableFuture.class)) {
            ...
            doReturn("String").when(paymentDetailsMock2).getPaymentUrl();
            //Act Statement(s)
