...
public class PaymentSessionSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${21a9d610-1142-33e9-bacd-86685e4cbd4a}, hash: 7ADF58A1A6359FC28D50A212E5A76CDC
    @Test()
    ...
    //Sapient generated method id: ${70feade1-ca5e-3d52-b7c0-632ee89e2b7b}, hash: DFC6A2819E1B4A66EF283CEB0F4ADB01
    @Test()
    ...
    //Sapient generated method id: ${58b05531-62cb-370d-88d1-f80781a705b0}, hash: 4E9713240B45F8F9E58089726968EDCF
    @Test()
    ...
    //Sapient generated method id: ${09cfda40-14e9-30a4-b63c-301f9a5ffb85}, hash: 7DCEA8B93287040508CA7D29B7E27568
    @Ignore()
    @Test()
    public void createFromBitcoinUri2WhenRequestIsNullThrowsPaymentProtocolException() throws PaymentProtocolException, IOException {
         ...
         *  A variable could not be isolated or mocked when calling a method - Variable name: uri - Method: toURL
         *  Suggestions:
    ...
    //Sapient generated method id: ${79a58b09-f32a-3df8-a746-34730b8e5683}, hash: E4E486279E850B93BE8317222DD5C7C1
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${b28c31b2-af1b-30a3-9fd7-9151cf56be5c}, hash: C1B8BAFC09866AC19700A7941630AB6E
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${a36e629e-f5ec-304a-9020-3bf91aaa6f55}, hash: D6BFCA1847359C50A8C97E52A15081BD
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${f816a26e-5b4a-3650-af90-915c29d4516d}, hash: 13EA86C13AE5968B769218CD66976B91
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${5ecd038f-a7e6-3e7d-9356-99cc441c23ff}, hash: 131F898EEB777C0AF77D33108F0DB570
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${308cad9f-e2c9-3904-8234-4dca559ef837}, hash: 46591387EFEFAD8AD7D876C1C8166E60
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${63ce3d21-b773-383c-aa43-f4d4d9f3ecd1}, hash: D183BCBF07E9F35F400AEADC447266E8
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${eab0d039-06de-35a0-b48a-56d224a91762}, hash: 008E51D678102451C06A62D67D33107E
    @Ignore()
    @Test()
    public void createFromBitcoinUri2WhenOutputHasAmountAndParamsNetworkNotExceedsMaxMoneyTotalValueAndDefaultBranch() throws PaymentProtocolException, KeyStoreException, IOException, FileNotFoundException, URISyntaxException {
        ...
        try (MockedStatic<ListenableCompletableFuture> listenableCompletableFuture = mockStatic(ListenableCompletableFuture.class);
             ...
             MockedStatic<Protos.PaymentRequest> protosPaymentRequest = mockStatic(Protos.PaymentRequest.class)) {
            doReturn("return_of_getPaymentRequestUrl1").when(uriMock).getPaymentRequestUrl();
            doReturn(keyStoreMock).when(nonNullTrustStoreLoaderMock).getKeyStore();
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            InputStream inputStream = new ByteArrayInputStream(byteArrayOutputStream.toByteArray());
            protosPaymentRequest.when(() -> Protos.PaymentRequest.parseFrom(inputStream)).thenReturn(protosPaymentRequestMock);
            doReturn(1).when(protosPaymentRequestMock).getPaymentDetailsVersion();
            ...
            doReturn(paymentDetailsMock).when(protosPaymentDetailsBuilderMock2).build();
            coin.when(() -> Coin.valueOf(0L)).thenReturn(coinMock);
            paymentProtocol.when(() -> PaymentProtocol.verifyPaymentRequestPki(protosPaymentRequestMock, keyStoreMock)).thenReturn(paymentProtocolPkiVerificationDataMock);
            CompletableFuture<PaymentSession> completableFuture = new CompletableFuture<>();
            listenableCompletableFuture.when(() -> ListenableCompletableFuture.of(completableFuture)).thenReturn(listenableCompletableFutureMock);
            doReturn(false).when(paymentDetailsMock).hasNetwork();
            doReturn(1).when(paymentDetailsMock).getOutputsCount();
            ...
            verify(protosPaymentDetailsBuilderMock2).build();
            coin.verify(() -> Coin.valueOf(0L), atLeast(1));
            paymentProtocol.verify(() -> PaymentProtocol.verifyPaymentRequestPki(protosPaymentRequestMock, keyStoreMock), atLeast(1));
            listenableCompletableFuture.verify(() -> ListenableCompletableFuture.of(completableFuture), atLeast(1));
            verify(paymentDetailsMock).hasNetwork();
            verify(paymentDetailsMock).getOutputsCount();
            verify(paymentDetailsMock).getOutputsList();
    ...
    //Sapient generated method id: ${c2b166ba-b05a-347b-97e8-8c349564654b}, hash: A8963DC386EF840D146A3CBF1DE97017
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${aafea915-0ddc-3f61-ae65-60120b0eccca}, hash: D374FD5EDE2CA13D05BEA0A1C4342ADB
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${fda5bfa5-7326-36ac-bf82-5f718b359f50}, hash: 8FA3CC53DE3F68C17B17E2C710A38432
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${ce6126b2-85fc-308f-bbdb-97a791504bef}, hash: 214C0A5777F3311D62C52560F04D67DD
    @Test()
    ...
    //Sapient generated method id: ${1933f8d5-1b54-33d0-8ea9-ce91b85749b5}, hash: 4778B5A79285D4E796399EDC553496B8
    @Test()
    ...
    //Sapient generated method id: ${ba5dbdec-2330-371e-8776-d1496383e459}, hash: 2F2211F57FA444B94B4EFE0D8E9A45DD
    @Test()
    ...
    //Sapient generated method id: ${be0b42ce-3038-35c0-9843-c7420eee4954}, hash: 71DA890383388F3648AA9AF3817BC0A1
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${b717e653-d521-351f-92da-b2d75456ea54}, hash: C3DCB3C2B433119DCCEEE50F70CED814
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${6a040022-e53d-31f7-914e-6cf4bed939d1}, hash: 99E5F9BF65A16C95C86357FC794B9782
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${59a505a2-beaf-3791-878a-ed318adf93fb}, hash: 6DC140586345DB3A67C4115D0CF73CC8
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${3bfcb2ca-5603-3b3f-89bc-2bb023aaaf62}, hash: FF3610AED5A949E331D04AB6C9EACDC5
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${209b0207-023f-361e-bc20-ed0f2a236734}, hash: 2A459FC080F4D052A71E2E68E21E8946
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${586cdfc1-cf58-37f0-82e3-c859fcea7d91}, hash: E50EBC03C89EABDD63165B79F6C67AE6
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${a05284d0-b5bb-3703-83c2-f621cc69ee06}, hash: 8ACCDEBEADBD8D0A79633E37640A1B9D
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${7b871488-a4e1-3495-acd0-b235f433c7e0}, hash: 197AC67279105D95DF298CB0433F8749
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${4cc14021-3391-334c-a091-aeba3194a876}, hash: FA50149780FE00858EF6F798A50EDC2E
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${dda59e6e-a830-3f07-874a-51fdee82d559}, hash: 6F5BF765B1402FBEF3735BE1FC866855
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${e9959f10-7902-3931-bf3d-db50b344350a}, hash: 847C33BE90E3C6D7B7AD6172B127DD7C
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${d2082401-9468-39f9-abf0-0d99df1ebb04}, hash: 98F286F92BAAB0934ED74E2D7784C9DF
    @Ignore()
    @Test()
    public void getOutputsWhenOutputHasAmount() throws InvalidProtocolBufferException, FileNotFoundException, KeyStoreException, PaymentProtocolException {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  A variable could not be isolated or mocked when calling a method - Variable name: totalValue - Method: add
         *  Suggestions:
         *  You can pass them as constructor arguments or create a setter for them (avoid new operator)
         *  or adjust the input/test parameter values manually to satisfy the requirements of the given test scenario.
         *  The test code, including the assertion statements, has been successfully generated.
        ...
        try (MockedStatic<Coin> coin = mockStatic(Coin.class);
            ...
            paymentProtocol.when(() -> PaymentProtocol.verifyPaymentRequestPki(requestMock, keyStoreMock)).thenReturn(paymentProtocolPkiVerificationDataMock);
            ...
            //Assert statement(s)
            //TODO: Please implement equals method in PaymentProtocol.Output for verification of the entire object or you need to adjust respective assertion statements
            ...
            paymentProtocol.verify(() -> PaymentProtocol.verifyPaymentRequestPki(requestMock, keyStoreMock), atLeast(1));
    ...
    //Sapient generated method id: ${c82bf0a8-32b6-387a-89ed-588eaa3e041a}, hash: 7E9F5779F7F7A006498561E73F62852A
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${c35b3640-8b1c-3b99-ae2a-582891843e3b}, hash: 216E9DA1238DF98AB8F305675D6F6623
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${1659e20e-cd61-3ee3-8e34-38ba781dbdbd}, hash: ACCB81774EAD6FDA1EDC6DE0897B0748
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${042a07c6-415f-3feb-9b50-b06f1fcd4b38}, hash: 39F2A635D72FC9A092D8E7358E04E7E6
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${32a264d3-e4bd-353f-a2bf-fe1cf1c16d84}, hash: 346C0AB1E66BC8CC92E1729C8FC1BBBE
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${49cad766-1ae4-3a20-9843-309c4205e5e0}, hash: 65986E40B5A46D0714799468396E3CEA
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${09bd9b1a-6122-3513-81fe-00c0d2fc317d}, hash: 838F2A7E88FF9BFC91407CA1B77D7C56
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${b59526a4-3e3d-333a-98ad-bf2a33c3b484}, hash: 17919708B0B70B56EECE064FC5301CB1
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${17995948-c48b-3508-848e-559f0c32880c}, hash: 2F9203F4A9B08BB796AD682BF63E4A97
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${9d0e3047-98b8-3eb0-9f2f-154bf4b1fe26}, hash: 782FF76804E9641530EF8AA2E8416D70
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${d05d52b3-90c7-3f41-8757-f1b20c8392e7}, hash: 919F09D49D1A2115ECDB24A6B5F7FFFA
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${c1c60ade-30ae-32fc-8306-294b6bd2cf93}, hash: 698778BC58FCF171FD3F05C93C69BBBF
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${f10f1d54-4f47-3aa1-9eff-55b655a06e3a}, hash: 08DAFE10C634C64813D024958DCA95C8
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${3291c934-55d8-377b-8a08-c01a1cdd650b}, hash: 1A52B3B5E0E163A755B5559430FC46A2
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${5946532e-1e5a-32ac-b1a1-0b6f757bb020}, hash: 402EE3B0FCB7367A414B35BD17806182
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${adc869a8-739d-3da6-9f2b-e2fe07a2be41}, hash: 4B3C6A1940C8F70A31467C729348D3BC
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${360ef9a4-fbb2-34fa-b8d7-91ebefdabdf0}, hash: 7ADE3D6CD62998052E3E92B7627CBB70
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${1ea7441c-6b59-37a7-b69b-8e89eb86028f}, hash: B30B7792FCE8679BC50170D2FC933FE2
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${e7f16d00-0f8b-38c3-ae83-47077ec3f99a}, hash: 63F9FE08711A3E5772A51153914C88CA
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${985cc91a-64db-3100-877e-f0beb1d102f0}, hash: DE8D69D460CF7E6458075E261DA6C1F6
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${930f4048-fc28-3365-a150-d97ef12c998c}, hash: EA097E8E053C3E64D0F29ABF4B9F6552
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${abe912d9-7c90-3a67-8ed8-350bc3c0a1ab}, hash: 1E0084AE4631A4C0EA5365ECF12BCBE0
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${da14b862-c9da-3d73-a403-287f39476292}, hash: C0F57669B8B2ABD88C24BB2B20FCA7A6
    @Ignore()
    @Test()
    public void sendPayment1Test() throws KeyStoreException, IOException, PaymentProtocolException, FileNotFoundException {
        ...
        try (MockedStatic<PaymentProtocol> paymentProtocol = mockStatic(PaymentProtocol.class);
            ...
            doReturn(0L).when(outputMock).getAmount();
            //Act Statement(s)
            CompletableFuture<PaymentProtocol.Ack> result = target.sendPayment(uRLMock, paymentMock);
            //Assert statement(s)
    ...
    //Sapient generated method id: ${b7d95427-d79a-3b0f-b536-fd30dfedd992}, hash: 6E35A03E0A65A023E2CEF91B62AD4205
    @Ignore()
    @Test()
