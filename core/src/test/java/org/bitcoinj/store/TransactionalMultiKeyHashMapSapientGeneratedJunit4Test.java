...
public class TransactionalMultiKeyHashMapSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${f2580bf9-57c5-38b8-b003-ac7734507635}, hash: 56804F93DEDC19A6E60BE83A7BBDD29C
    @Test()
    ...
    //Sapient generated method id: ${634b31cf-7a2f-3f9b-9203-5127ac44586f}, hash: 7C2872AA8B3490725DC8764D60C604E5
    @Test()
    ...
    //Sapient generated method id: ${a1e67f11-404f-33fa-aa6c-c1875a1a5c52}, hash: D013A85C847B1DB98152F6589DE219D1
    @Test()
    ...
    //Sapient generated method id: ${9c25887d-767d-38e9-b5ae-c2e4012c49be}, hash: 46D6117143AD6424FBA2C0C29266FE58
    @Test()
    public void getTest() {
        //Arrange Statement(s)
        target = new TransactionalMultiKeyHashMap<>();
        ...
        verify(mapValuesMock, atLeast(1)).get(object2);
    }

    //Sapient generated method id: ${41653620-2a9b-3c46-8b79-25f8bbf36c23}, hash: 96B1EC8A3BFE5ED279B964A5E671E4BF
    @Test()
    ...
    //Sapient generated method id: ${bb9c92a1-f34a-3b3a-9997-40367ebee9ef}, hash: C67A9AECF79900ED77E15285E15498AD
    @Test()
    public void removeByUniqueKeyTest() {
        ...
        //Assert statement(s)
        assertThat(result, equalTo(object));
        verify(mapValuesMock, atLeast(1)).remove(object2);
    }

    //Sapient generated method id: ${93a37ec3-b3bf-348f-9153-ae969a5fb211}, hash: E2FD6AC05B212B39F5BA267458DD0F75
    @Test()
