...
public class WalletAppKitSapientGeneratedJunit4Test {
    ...
    PeerAddress[][] peerAddressArray3 = new PeerAddress[][] { peerAddressMock };
    InetAddress inetAddress = InetAddress.getLoopbackAddress();
    PeerAddress peerAddress = PeerAddress.simple(inetAddress, 0);
    PeerAddress[][] peerAddressArray4 = new PeerAddress[][] { peerAddress };
    PeerAddress peerAddress2 = PeerAddress.simple(inetAddress, 0);
    PeerAddress[][] peerAddressArray5 = new PeerAddress[][] { peerAddress2 };
    PeerAddress[] peerAddressArray2 = new PeerAddress[] { peerAddressArray3, peerAddressArray4, peerAddressArray5 };
    ...
    NetworkParameters networkParameters = NetworkParameters.fromID("id1");
    File file = new File("pathname1");
    target = new WalletAppKit(networkParameters, ScriptType.P2PKH, keyChainGroupStructureMock, file, "filePrefix");
    autoCloseableMocks = MockitoAnnotations.openMocks(this);
    thrown.expect(IllegalStateException.class);
    //Act Statement(s)
    target.setAutoSave(true);
    ...
    target = spy(new WalletAppKit(paramsMock, ScriptType.P2PKH, keyChainGroupStructureMock, file2, ""));
    autoCloseableMocks = MockitoAnnotations.openMocks(this);
    ...
    doReturn(listenableCompletableFuture).when(vPeerGroupMock).startAsync();
    ...
    checkpointManager.when(() -> CheckpointManager.openStream((NetworkParameters) any())).thenReturn(null);
    NetworkParameters networkParameters3 = NetworkParameters.fromID("id1");
    File file2 = new File("pathname1");
    target = spy(new WalletAppKit(networkParameters3, ScriptType.P2PKH, keyChainGroupStructureMock, file2, "wallet"));
    autoCloseableMocks = MockitoAnnotations.openMocks(this);
    ...
    checkpointManager.verify(() -> CheckpointManager.openStream((NetworkParameters) any()));
    ...
    @Test()
    public void startUpWhenParamsNetworkNotEqualsBitcoinNetworkREGTESTAndDiscoveryIsNullAndAutoStopAndBlockingStartup8() throws Exception, IOException, UnreadableWalletException {
        /* Branches:
         * (!directory.exists()) : true
         * (!directory.mkdirs()) : false
         * (vWalletFile.exists()) : true
    ...
    doReturn(null).when(vWalletMock).earliestKeyCreationTime();
    ...
    @Test()
    public void startUpWhenParamsNetworkNotEqualsBitcoinNetworkREGTESTAndDiscoveryIsNullAndAutoStopAndBlockingStartup11() throws Exception, IOException, UnreadableWalletException {
        /* Branches:
         * (!directory.exists()) : true
         * (!directory.mkdirs()) : false
    ...
    public void createPeerGroupTest() {
        ...
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            ...
            networkParameters.when(() -> NetworkParameters.of(BitcoinNetwork.MAINNET)).thenReturn(networkParametersMock);
            File file = new File("pathname1");
            target = new WalletAppKit(paramsMock, ScriptType.P2PKH, keyChainGroupStructureMock, file, "test");
            autoCloseableMocks = MockitoAnnotations.openMocks(this);
            //Act Statement(s)
    ...
    public void chainWhenStateEqualsStateRUNNING() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            target = new WalletAppKit(paramsMock, ScriptType.P2PKH, keyChainGroupStructureMock, (File) null, "wallet");
            autoCloseableMocks = MockitoAnnotations.openMocks(this);
            //Act Statement(s)
    ...
    public void chainWhenStateNotEqualsStateRUNNING() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            preconditions.when(() -> Preconditions.checkState(eq(true), (Supplier) any())).thenAnswer((Answer<Void>) invocation -> null);
            File file = new File("pathname1");
            target = new WalletAppKit(paramsMock, ScriptType.P2PKH, keyChainGroupStructureMock, file, "{value=String}");
            autoCloseableMocks = MockitoAnnotations.openMocks(this);
            //Act Statement(s)
            BlockChain result = target.chain();
            //Assert statement(s)
    ...
    public void storeWhenStateEqualsStateRUNNING() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class);
            ...
            NetworkParameters networkParameters3 = NetworkParameters.fromID("id1");
            File file = new File("pathname1");
            target = new WalletAppKit(networkParameters3, ScriptType.P2PKH, keyChainGroupStructureMock, file, "my_wallet");
            autoCloseableMocks = MockitoAnnotations.openMocks(this);
            //Act Statement(s)
