...
public class ByteUtilsSapientGeneratedJunit4Test {
    ...
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16LE(1, byteBuffer);
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16LE(65536, byteBuffer);
    ByteBuffer byteBuffer2 = ByteBuffer.allocateDirect(0);
    //Assert statement(s)
    assertThat(result, equalTo(byteBuffer2));
    preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
    ...
    public void writeInt16BEWhenValLessThanOrEqualsToMAX_UNSIGNED_SHORT() throws BufferOverflowException {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            ...
            ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
            //Act Statement(s)
            ByteBuffer result = ByteUtils.writeInt16BE(1, byteBuffer);
            ByteBuffer byteBuffer2 = ByteBuffer.allocateDirect(0);
            //Assert statement(s)
            assertThat(result, equalTo(byteBuffer2));
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
    ...
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
    //Act Statement(s)
    ByteBuffer result = ByteUtils.writeInt16BE(65536, byteBuffer);
    ByteBuffer byteBuffer2 = ByteBuffer.allocateDirect(0);
    //Assert statement(s)
    assertThat(result, equalTo(byteBuffer2));
    preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
    ...
    public void writeInt32LE1WhenValGreaterThanMAX_UNSIGNED_INTEGER() throws BufferOverflowException {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            ...
            ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
            //Act Statement(s)
            ByteBuffer result = ByteUtils.writeInt32LE(4294967296L, byteBuffer);
            ByteBuffer byteBuffer2 = ByteBuffer.allocateDirect(0);
            //Assert statement(s)
            assertThat(result, equalTo(byteBuffer2));
            preconditions.verify(() -> Preconditions.checkArgument(eq(false), (Supplier) any()));
    ...
    public void writeInt32BE1Test() throws BufferOverflowException {
        ...
        //ByteBuffer byteBuffer = ByteBuffer.allocateDirect(0);
        //Act Statement(s)
        //ByteBuffer result = ByteUtils.writeInt32BE(123456, byteBuffer);
        //ByteOrder byteOrder = ByteOrder.BIG_ENDIAN;
        //ByteBuffer byteBuffer2 = byteBuffer.order(byteOrder);
        //ByteBuffer byteBuffer3 = byteBuffer2.putInt(123456);
        //Assert statement(s)
        //assertThat(result, equalTo(byteBuffer3));
    }
    ...
    public void decodeMPIWhenNotIsNegative() {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS)) {
            ...
            byteUtils.when(() -> ByteUtils.readUint32BE(byteArray, 0)).thenReturn(16909060L);
            //Act Statement(s)
            BigInteger result = ByteUtils.decodeMPI(byteArray, true);
            //Assert statement(s)
            assertThat(result, equalTo(new BigInteger("0")));
    ...
    public void decodeMPIWhenIsNegative() {
         ...
         */
        //Arrange Statement(s)
        byte[] byteArray = new byte[]{(byte) 127, (byte) 1, (byte) 2, (byte) 3};
        //Act Statement(s)
        BigInteger result = ByteUtils.decodeMPI(byteArray, false);
        //Assert statement(s)
        assertThat(result, equalTo(new BigInteger("2130772483")));
    }
    ...
    public void encodeMPIWhenIsNegative() {
        ...
        //Arrange Statement(s)
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS)) {
            byte[] byteArray = new byte[]{(byte) 0, (byte) 0, (byte) 0, (byte) 7, (byte) 91, (byte) -51, (byte) 21, (byte) 0};
    ...
    public void encodeMPIWhenLengthNotEqualsArrayLengthAndIsNegative() {
        ...
        //Arrange Statement(s)
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS)) {
            byte[] byteArray = new byte[]{(byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) -128, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0};
            byteUtils.when(() -> ByteUtils.writeInt32BE(9, byteArray, 0)).thenAnswer((Answer<Void>) invocation -> null);
            //Act Statement(s)
            byte[] result = ByteUtils.encodeMPI(new BigInteger("-9223372036854775808"), true);
            //Assert statement(s)
            assertThat(result, equalTo(byteArray));
            byteUtils.verify(() -> ByteUtils.writeInt32BE(9, byteArray, 0), atLeast(1));
        }
    }
