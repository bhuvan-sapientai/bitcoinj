...
public class InternalUtilsSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${abb80eac-c61c-3008-8fe8-b9821f89b953}, hash: CE339A7F57943E372306320A46B26965
    @Test()
    ...
    //Sapient generated method id: ${6236fe84-81c2-3f91-8913-2139fbdb401a}, hash: C6E04928ED7936400A83936F351597F5
    @Test()
    ...
    //Sapient generated method id: ${b7e6f87d-48be-3a82-928e-72b874eeef4d}, hash: 2F3F4356DB25A5C1C70A769BEEF98F58
    @Test()
    ...
    //Sapient generated method id: ${1fe4e064-512b-388e-988b-9eae0e617966}, hash: 6ACF69E852D39144BFCDEE8AB2C427C9
    ...
    //Sapient generated method id: ${a67de9d2-5d40-3245-aa13-b71d01084a76}, hash: 8ED9CE7EE547DC14AD3219797DAECCBC
    ...
    public void getUninterruptiblyWhenInterruptedThrowsThrowable() throws ExecutionException, InterruptedException {
         ...
         *
         * TODO: Help needed! This method is not unit testable!
         *  Potential harmful system call (Future.get, Thread.interrupt) detected; Learn more: https://github.com/Sapient-AI/docs#disabled-generated-tests
         *  Suggestions:
         *  This method should be avoided from unit testing. This can be covered during integration testing.
         *  The test code, including the assertion statements, has been successfully generated.
         */
