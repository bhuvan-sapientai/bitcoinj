...
public class LegacyAddressSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${79fa68aa-0c43-3870-91d5-0a917e163aec}, hash: 817F5023BD34B3154F3E3A3959A891CF
    @Test()
    ...
    //Sapient generated method id: ${4cf58fae-b862-3e2e-ba5b-9dfef56ed1a1}, hash: 961921AD543AC306C2F29F21C6C698D5
    @Test()
    ...
    //Sapient generated method id: ${bb0cb823-1d23-33b4-9331-4d8c1a8de53d}, hash: A649E09B9452180D682F33B8E9185B7E
    @Test()
    ...
    //Sapient generated method id: ${0f8677e5-1136-39bc-a834-9dd78dde00fb}, hash: 81D36AEAA07543EBE33AC68E3DF470D2
    @Test()
    ...
    //Sapient generated method id: ${d753a76d-5c29-3370-9d0f-8a56356fc6f2}, hash: C94202DE195E4F36432F99C973379466
    @Test()
    ...
    //Sapient generated method id: ${282c9809-4cd2-35ef-82ef-b6a605f9b9f2}, hash: 07EDD35FC7B1AD7468E1A4888316458F
    @Test()
    ...
    //Sapient generated method id: ${8510bfd3-68d7-3f42-a5b0-1e40cbf83e55}, hash: B13EA82490D7A14D4F178F16CB3643A1
    @Test()
    ...
    //Sapient generated method id: ${e8953178-2cec-370c-a293-78116cabcb85}, hash: C10F543929362C408374E1340F1CD06C
    @Test()
    ...
    //Sapient generated method id: ${3af5b857-accb-3fc3-bf10-0e28cf0e4939}, hash: A39B2B21E8A40C6522BF6CA650CBCBCC
    @Test()
    public void fromBase581WhenVersionNotEqualsNetworkLegacyP2SHHeaderThrowsAddressFormatExceptionWrongNetwork() throws AddressFormatException, WrongNetwork {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            doReturn(2).when(networkMock2).legacyP2SHHeader();
    ...
    //Sapient generated method id: ${1c4558e4-0a5f-33f9-96ec-b3bd2fc69962}, hash: DB3E9C8292F290E55422983DDCB273B9
    @Test()
    ...
    //Sapient generated method id: ${82756cd6-efc2-395d-a8e8-c86c1c59e46c}, hash: 774A9AEB9B4E6CC376C02ED42639CCBE
    @Ignore()
    @Test()
    public void fromBase581WhenDefaultBranch() throws AddressFormatException, WrongNetwork {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            //Assert statement(s)
            assertThat(result, is(notNullValue()));
            verify(networkMock2, atLeast(1)).legacyAddressHeader();
            base58.verify(() -> Base58.decodeChecked("A"), atLeast(1));
        }
    }

    //Sapient generated method id: ${7c9c139f-7435-3707-ad38-58cee4f1f08b}, hash: FAD0ED6480621C1AB4538142EFF68B1F
    @Ignore()
    @Test()
    public void fromBase581WhenNetworkNotInstanceOfBitcoinNetworkAndDefaultBranchThrowsAddressFormatExceptionInvalidDataLength() throws AddressFormatException, WrongNetwork {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            base58.when(() -> Base58.decodeChecked("3CWFddi6m4ndiGyKqzYvsFYagqDLPVMTzC")).thenReturn(byteArray);
            AddressFormatException.InvalidDataLength addressFormatExceptionInvalidDataLength = new AddressFormatException.InvalidDataLength("Legacy addresses are 20 byte (160 bit) hashes, but got: 0");
            thrown.expect(AddressFormatException.InvalidDataLength.class);
            thrown.expectMessage(addressFormatExceptionInvalidDataLength.getMessage());
            //Act Statement(s)
            LegacyAddress.fromBase58("3CWFddi6m4ndiGyKqzYvsFYagqDLPVMTzC", networkMock2);
            //Assert statement(s)
            verify(networkMock2).legacyAddressHeader();
            verify(networkMock2).legacyP2SHHeader();
            base58.verify(() -> Base58.decodeChecked("3CWFddi6m4ndiGyKqzYvsFYagqDLPVMTzC"), atLeast(1));
        }
    }

    //Sapient generated method id: ${f9d6d2c1-ada0-3afa-ac24-51115d2c6bbe}, hash: D017DEC8652E9D7C00D9302C11B62FBF
    @Ignore()
    @Test()
    public void fromBase581WhenNetworkNotInstanceOfBitcoinNetworkAndDefaultBranch() throws AddressFormatException, WrongNetwork {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class)) {
            ...
            //Act Statement(s)
            LegacyAddress result = LegacyAddress.fromBase58("3QJmV3qfvL9SuYo34YihAf3sRCW3qSinyC", networkMock2);
            //Assert statement(s)
            assertThat(result, is(notNullValue()));
            verify(networkMock2, atLeast(1)).legacyAddressHeader();
            verify(networkMock2, atLeast(1)).legacyP2SHHeader();
            base58.verify(() -> Base58.decodeChecked("3QJmV3qfvL9SuYo34YihAf3sRCW3qSinyC"), atLeast(1));
        }
    }

    //Sapient generated method id: ${b444423d-8062-3e94-803b-01f5c4c4e2cc}, hash: 9D51E6E16F8061952819E7FB02497CDC
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${c38b3e41-62e2-35de-bc9a-013d56ed3b0b}, hash: 11B698F226D3BD56125667CC17FE4F9E
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${46194f1b-99a4-3203-97b3-9dfd7f9bcf1d}, hash: ACB3574CB146BA3D5153C18A8798D2F3
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${025c4b8d-5cd5-3634-a252-2f4b48c82089}, hash: 7A5EF011145A1CBDB1783691AE8F11C2
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${62620fc3-0f73-33ec-bac4-94cb56b7b5f8}, hash: BDC3A7564F46B4441A88B7702ACE1F2B
    @Ignore()
    @Test()
    public void getParametersFromAddressTest() throws AddressFormatException {
        ...
        try (MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            networkParameters.when(() -> NetworkParameters.fromAddress((Address) any())).thenReturn(networkParametersMock);
            //Act Statement(s)
            NetworkParameters result = LegacyAddress.getParametersFromAddress("A");
            //Assert statement(s)
            assertThat(result, equalTo(networkParametersMock));
            networkParameters.verify(() -> NetworkParameters.fromAddress((Address) any()));
        }
    }

    //Sapient generated method id: ${363d3698-f34c-39ad-914f-376a19498023}, hash: 7C6969651FF5A138650683406BEA0D1B
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${af5f6332-26a2-3749-8f9a-ac87ce6fe7cf}, hash: C2A28DC609FB5EC43F3A88351837A977
    @Ignore()
    @Test()
    public void compareToTest() throws AddressFormatException {
        /*
         * TODO: Help needed! This method is not unit testable!
         *  Following variables could not be isolated/mocked: LEGACY_ADDRESS_COMPARATOR
         *  Suggestions:
