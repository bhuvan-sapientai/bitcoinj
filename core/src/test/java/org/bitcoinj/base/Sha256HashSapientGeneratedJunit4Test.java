...
public class Sha256HashSapientGeneratedJunit4Test {
    ...
    private final MessageDigest messageDigestMock = mock(MessageDigest.class, "newDigest()");
    ...
    public void hash1Test() throws NoSuchAlgorithmException {
         ...
         */
        //Arrange Statement(s)
        MessageDigest messageDigestMock = mock(MessageDigest.class, "<value>");
        try (MockedStatic<Sha256Hash> sha256Hash = mockStatic(Sha256Hash.class, CALLS_REAL_METHODS)) {
            sha256Hash.when(() -> Sha256Hash.newDigest()).thenReturn(messageDigestMock);
            byte[] byteArray = new byte[]{(byte) 0};
            //Act Statement(s)
            byte[] result = Sha256Hash.hash(byteArray, 0, 0);
            //Assert statement(s)
    ...
    public void hashTwice1Test() throws NoSuchAlgorithmException {
         ...
         */
        //Arrange Statement(s)
        MessageDigest messageDigestMock = mock(MessageDigest.class, "MessageDigest");
        try (MockedStatic<Sha256Hash> sha256Hash = mockStatic(Sha256Hash.class, CALLS_REAL_METHODS)) {
            sha256Hash.when(() -> Sha256Hash.newDigest()).thenReturn(messageDigestMock);
            byte[] byteArray = new byte[]{(byte) 0};
    ...
    public void hashTwice2Test() throws NoSuchAlgorithmException {
        ...
        try (MockedStatic<Sha256Hash> sha256Hash = mockStatic(Sha256Hash.class, CALLS_REAL_METHODS)) {
            ...
            byte[] byteArray = new byte[]{(byte) 0};
            //Act Statement(s)
            byte[] result = Sha256Hash.hashTwice(byteArray, 0, 32);
            //Assert statement(s)
            assertThat(result, is(nullValue()));
            sha256Hash.verify(() -> Sha256Hash.newDigest(), atLeast(1));
        }
    ...
    public void hashTwice3Test() throws NoSuchAlgorithmException {
        ...
        try (MockedStatic<Sha256Hash> sha256Hash = mockStatic(Sha256Hash.class, CALLS_REAL_METHODS)) {
            ...
            byte[] byteArray2 = new byte[]{(byte) 0};
            //Act Statement(s)
            byte[] result = Sha256Hash.hashTwice(byteArray, 0, 32, byteArray2, 0, 32);
            //Assert statement(s)
            assertThat(result, is(nullValue()));
            sha256Hash.verify(() -> Sha256Hash.newDigest(), atLeast(1));
        }
