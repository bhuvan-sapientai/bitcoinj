...
public class TestNet3ParamsSapientGeneratedJunit4Test {
    ...
    public void checkDifficultyTransitionsWhenNextBlockGetDifficultyTargetNotEqualsPrevGetDifficultyTargetThrowsVerificationException() throws VerificationException, BlockStoreException {
        ...
        Block block2 = new Block(0L, sha256HashMock3, sha256HashMock4, instant2, 0L, 2L, list2);
    ...
    public void checkDifficultyTransitionsWhenNextBlockGetDifficultyTargetEqualsPrevGetDifficultyTarget() throws VerificationException, BlockStoreException {
        ...
        Instant instant2 = Instant.ofEpochSecond(1700000000);
        List list2 = new ArrayList<>();
        Block block2 = new Block(0L, sha256HashMock3, sha256HashMock4, instant2, 0L, 1L, list2);
        BlockStore blockStoreMock = mock(BlockStore.class, "BlockStore");
    ...
    public void checkDifficultyTransitionsWhenCursorIsNullThrowsVerificationException() throws VerificationException, BlockStoreException {
        ...
        try (MockedStatic<Stopwatch> stopwatch = mockStatic(Stopwatch.class)) {
            ...
            doReturn(sha256Hash).when(prevMock).getHash();
    ...
    public void checkDifficultyTransitionsWhenCursorGetHeaderGetDifficultyTargetAsIntegerEqualsGetMaxTargetAThrowsVerificationException() throws VerificationException, BlockStoreException {
        ...
        thrown.expect(VerificationException.class);
        StoredBlock storedBlock = new StoredBlock(prevMock, new BigInteger("0"), 1);
        Sha256Hash sha256HashMock = mock(Sha256Hash.class);
        Sha256Hash sha256HashMock2 = mock(Sha256Hash.class);
        Instant instant = Instant.ofEpochSecond(1700000000);
        List list = new ArrayList<>();
    ...
    public void checkDifficultyTransitionsWhenCursorGetHeaderGetDifficultyTargetAsIntegerEqualsGetMaxTargetAndCursorTargetEqualsNewTarg() throws VerificationException, BlockStoreException {
        ...
        //Arrange Statement(s)
        Block prevMock = mock(Block.class);
        doReturn(1699998800L).when(prevMock).getTimeSeconds();
        doReturn(new BigInteger("26959535291011309493156476344723991336010898738574164086137773096960")).when(prevMock).getDifficultyTargetAsInteger();
        target = spy(new TestNet3Params());
        autoCloseableMocks = MockitoAnnotations.openMocks(this);
        doReturn(false).when(target).isDifficultyTransitionPoint(1);
    ...
    //Sapient generated method id: ${f9d6a442-7d9d-3507-9385-97139422d195}
    @Test()
    public void checkDifficultyTransitionsWhenNewTargetCompactNotEqualsReceivedTargetCompactThrowsVerificationException() throws VerificationException, BlockStoreException {
        ...
        Sha256Hash sha256HashMock200 = mock(Sha256Hash.class);
        Sha256Hash sha256HashMock201 = mock(Sha256Hash.class);
        Block block101Mock = mock(Block.class);
        Sha256Hash sha256HashMock202 = mock(Sha256Hash.class);
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class, CALLS_REAL_METHODS)) {
            ...
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock3);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock5);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock7);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock9);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock11);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock13);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock15);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock17);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock19);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock21);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock23);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock25);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock27);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock29);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock31);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock33);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock35);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock37);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock39);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock41);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock43);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock45);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock47);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock49);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock51);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock53);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock55);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock57);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock59);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock61);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock63);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock65);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock67);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock69);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock71);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock73);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock75);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock77);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock79);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock81);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock83);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock85);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock87);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock89);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock91);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock93);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock95);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock97);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock99);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock101);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock103);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock105);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock107);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock109);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock111);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock113);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock115);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock117);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock119);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock121);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock123);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock125);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock127);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock129);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock131);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock133);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock135);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock137);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock139);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock141);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock143);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock145);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock147);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock149);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock151);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock153);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock155);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock157);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock159);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock161);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock163);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock165);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock167);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock169);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock171);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock173);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock175);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock177);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock179);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock181);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock183);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock185);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock187);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock189);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock191);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock193);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock195);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock197);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock199);
            verify(blockStoreMock, atLeast(1)).get(sha256HashMock201);
    ...
    //Sapient generated method id: ${92b12ee4-ac9e-3fec-83e3-335d54a318bf}
    @Test()
