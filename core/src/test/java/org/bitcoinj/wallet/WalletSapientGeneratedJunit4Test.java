...
public class WalletSapientGeneratedJunit4Test {
    ...
    private final Network networkMock = mock(Network.class, "networkValue");
    ...
    public void fromWatchingKeyB58WhenHeaderEqualsParamsGetBip32HeaderP2PKHpriv() {
        ...
        //Arrange Statement(s)
        DeterministicKey deterministicKeyMock = mock(DeterministicKey.class);
        Network networkMock2 = mock(Network.class, "Network");
        ...
        try (MockedStatic<Wallet> wallet = mockStatic(Wallet.class, CALLS_REAL_METHODS);
            ...
            deterministicKey.when(() -> DeterministicKey.deserializeB58(null, "String", networkMock2)).thenReturn(deterministicKeyMock);
            ...
            //Act Statement(s)
            Wallet result = Wallet.fromWatchingKeyB58(networkMock2, "String", instant);
            //Assert statement(s)
            assertThat(result, equalTo(walletMock));
            deterministicKey.verify(() -> DeterministicKey.deserializeB58(null, "String", networkMock2), atLeast(1));
    ...
    public void fromSpendingKeyB58WhenHeaderEqualsParamsGetBip32HeaderP2PKHpriv() {
        ...
        try (MockedStatic<Wallet> wallet = mockStatic(Wallet.class, CALLS_REAL_METHODS);
            ...
            Instant instant = Instant.now();
            //Act Statement(s)
            Wallet result = Wallet.fromSpendingKeyB58(networkMock2, "String", instant);
            //Assert statement(s)
            assertThat(result, equalTo(walletMock));
            deterministicKey.verify(() -> DeterministicKey.deserializeB58(null, "String", networkMock2), atLeast(1));
            verify(deterministicKeyMock, atLeast(1)).setCreationTime((Instant) any());
    ...
    public void fromSpendingKeyB58WhenHeaderNotEqualsParamsGetBip32HeaderP2WPKHprivThrowsIllegalArgumentException() {
        ...
        try (MockedStatic<Base58> base58 = mockStatic(Base58.class);
            ...
            byte[] byteArray = new byte[]{(byte) 0};
            base58.when(() -> Base58.decodeChecked("String")).thenReturn(byteArray);
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("Stri");
            thrown.expect(IllegalArgumentException.class);
            thrown.expectMessage(illegalArgumentException.getMessage());
            Instant instant = Instant.now();
            //Act Statement(s)
            Wallet.fromSpendingKeyB58(networkMock2, "String", instant);
            //Assert statement(s)
            deterministicKey.verify(() -> DeterministicKey.deserializeB58(null, "String", networkMock2), atLeast(1));
            verify(deterministicKeyMock).setCreationTime((Instant) any());
            networkParameters.verify(() -> NetworkParameters.of(networkMock2), atLeast(1));
    ...
    //Sapient generated method id: ${7b958588-ead8-3acf-aca8-8c01cdf340be}
    @Test()
    ...
    //Sapient generated method id: ${e6c3d614-f8c3-3f9e-9e51-cde296d4c982}
    @Test()
    ...
    public void saveToFileWhenCaughtRuntimeExceptionThrowsRuntimeException() throws IOException {
        ...
        try (MockedStatic<PlatformUtils> platformUtils = mockStatic(PlatformUtils.class);
            ...
            addressParser.when(() -> AddressParser.getDefault(networkMock)).thenReturn(addressParser2);
            defaultCoinSelector.when(() -> DefaultCoinSelector.get(networkMock)).thenReturn(coinSelectorMock);
    ...
    //Sapient generated method id: ${5cbe7a21-ac96-3c73-a212-7e322d7af657}
    @Test()
    public void saveToFileWhenTempFileExists() throws IOException {
         ...
         */
        //Arrange Statement(s)
        CoinSelector coinSelectorMock = mock(CoinSelector.class, "CoinSelectorValue");
        Network networkMock2 = mock(Network.class);
        try (MockedStatic<PlatformUtils> platformUtils = mockStatic(PlatformUtils.class);
             MockedStatic<DefaultCoinSelector> defaultCoinSelector = mockStatic(DefaultCoinSelector.class);
             MockedStatic<AddressParser> addressParser = mockStatic(AddressParser.class);
    ...
    //Sapient generated method id: ${b285f83a-658d-34c2-b0f9-b8910d3b181e}
    @Test()
    ...
    public void loadFromFile1Test() throws Throwable, IOException {
        ...
        //Arrange Statement(s)
        Wallet walletMock = mock(Wallet.class, "Wallet");
        WalletProtobufSerializer.WalletFactory walletProtobufSerializerWalletFactoryMock = mock(WalletProtobufSerializer.WalletFactory.class, "factory");
        WalletExtension walletExtensionMock = mock(WalletExtension.class, "walletExtensions");
        try (MockedStatic<Wallet> wallet = mockStatic(Wallet.class, CALLS_REAL_METHODS)) {
            FileInputStream fileInputStream = mock(FileInputStream.class);
            WalletExtension[] walletExtensionArray = new WalletExtension[]{walletExtensionMock};
    ...
    public void loadFromFile1WhenCaughtIOExceptionThrowsUnreadableWalletException() throws UnreadableWalletException, IOException {
        ...
        //Arrange Statement(s)
        Wallet walletMock = mock(Wallet.class, "Wallet");
        WalletProtobufSerializer.WalletFactory walletProtobufSerializerWalletFactoryMock = mock(WalletProtobufSerializer.WalletFactory.class, "factoryValue");
        WalletExtension walletExtensionMock = mock(WalletExtension.class, "walletExtensionsValue");
        try (MockedStatic<Wallet> wallet = mockStatic(Wallet.class, CALLS_REAL_METHODS)) {
            FileInputStream fileInputStream = mock(FileInputStream.class);
            WalletExtension[] walletExtensionArray = new WalletExtension[]{walletExtensionMock};
            wallet.when(() -> Wallet.loadFromFileStream(fileInputStream, walletProtobufSerializerWalletFactoryMock, false, false, walletExtensionArray)).thenReturn(walletMock);
    ...
    public void notifyTransactionIsInBlockWhenTxIsNotNullThrowsIllegalStateException() throws VerificationException {
        ...
        try (MockedStatic<AddressParser> addressParser = mockStatic(AddressParser.class);
            ...
            //Act Statement(s)
            target.notifyTransactionIsInBlock(sha256Hash, storedBlock, AbstractBlockChain.NewBlockType.BEST_CHAIN, 0);
            //Assert statement(s)
            threading.verify(() -> Threading.lock("Wallet-KeyChainGroup lock"), atLeast(1));
            networkParameters.verify(() -> NetworkParameters.of(networkMock), atLeast(1));
            addressParser.verify(() -> AddressParser.getDefault(networkMock), atLeast(1));
    ...
    public void notifyTransactionIsInBlockWhenTxIsNull() throws VerificationException, UTXOProviderException, IOException {
         ...
         */
        //Arrange Statement(s)
        CoinSelector coinSelectorMock = mock(CoinSelector.class, "CoinSelector value");
        Network networkMock2 = mock(Network.class);
        Block blockMock = mock(Block.class);
        try (MockedStatic<DefaultCoinSelector> defaultCoinSelector = mockStatic(DefaultCoinSelector.class);
             MockedStatic<AddressParser> addressParser = mockStatic(AddressParser.class);
            ...
            StoredBlock storedBlock = new StoredBlock(blockMock, new BigInteger("0"), 0);
            //Act Statement(s)
            boolean result = target.notifyTransactionIsInBlock(sha256Hash, storedBlock, AbstractBlockChain.NewBlockType.BEST_CHAIN, 0);
            //Assert statement(s)
            assertThat(result, equalTo(Boolean.FALSE));
            threading.verify(() -> Threading.lock("Wallet-KeyChainGroup lock"), atLeast(1));
            networkParameters.verify(() -> NetworkParameters.of(networkMock), atLeast(1));
    ...
    public void getWatchedOutputsTest() {
         ...
         */
        //Arrange Statement(s)
        CoinSelector coinSelectorMock = mock(CoinSelector.class, "DefaultCoinSelector.get(network)");
        Collector collectorMock = mock(Collector.class, "StreamUtils.toUnmodifiableList()");
        Network networkMock2 = mock(Network.class);
    ...
    public void getBalanceFutureWhenCurrentCompareToValueLessThan0() throws UTXOProviderException {
        ...
        try (MockedStatic<ListenableCompletableFuture> listenableCompletableFuture = mockStatic(ListenableCompletableFuture.class);
            ...
            verify(coinMock, atLeast(1)).compareTo(coinMock2);
        }
    }
    ...
    public void completeTxWhenReqTxGetOutputsStreamIsEmptyFilterScriptPatternIsOpReturnOGetScriptPThrowsWalletMultipleOpReturnRequested() throws InsufficientMoneyException, CompletionException, ScriptException {
        ...
        Coin coinMock2 = mock(Coin.class);
        Transaction txMock3 = mock(Transaction.class);
        Transaction txMock4 = mock(Transaction.class);
        Transaction txMock5 = mock(Transaction.class);
        TransactionInput transactionInputMock = mock(TransactionInput.class);
        Transaction txMock6 = mock(Transaction.class);
        Transaction txMock7 = mock(Transaction.class);
        Coin coinMock3 = mock(Coin.class);
        Transaction txMock8 = mock(Transaction.class);
        Coin coinMock4 = mock(Coin.class);
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class);
            ...
            List<TransactionOutput> transactionOutputList = new ArrayList<>();
            doReturn(transactionOutputList).when(txMock).getOutputs();
            doReturn(coinMock2).when(txMock2).getOutputSum();
            doReturn("return_of_toFriendlyString1").when(coinMock2).toFriendlyString();
            doReturn("return_of_toFriendlyString1").when(coinMock).toFriendlyString();
            ...
            List<TransactionInput> transactionInputList = new ArrayList<>();
            doReturn(transactionInputList).when(txMock3).getInputs();
            doNothing().when(txMock4).clearInputs();
            doReturn(transactionInputMock).when(txMock5).addInput((TransactionInput) null);
            List<TransactionInput> transactionInputList2 = new ArrayList<>();
            doReturn(transactionInputList2).when(txMock6).getInputs();
            doReturn(coinMock3).when(txMock7).getInputSum();
            doReturn(coinMock4).when(txMock8).getOutputSum();
            doReturn(coinMock5).when(coinMock4).subtract(coinMock3);
            List<TransactionOutput> transactionOutputList3 = new ArrayList<>();
            doReturn(transactionOutputList3).when(transactionMock).getOutputs();
            ...
            verify(txMock).getOutputs();
            verify(txMock2).getOutputSum();
            verify(coinMock2).toFriendlyString();
            verify(coinMock).toFriendlyString();
            verify(target).calculateAllSpendCandidates(true, true);
            verify(txMock3).getInputs();
            verify(txMock4).clearInputs();
            verify(txMock5).addInput((TransactionInput) null);
            verify(txMock6).getInputs();
            verify(txMock7).getInputSum();
            verify(txMock8).getOutputSum();
    ...
    public void completeTxWhenReqTxGetOutputsSizeNotEquals1ThrowsIllegalStateException() throws InsufficientMoneyException, CompletionException, ScriptException {
        ...
        Transaction txMock9 = mock(Transaction.class);
        TransactionOutput transactionOutputMock2 = mock(TransactionOutput.class);
        Transaction txMock10 = mock(Transaction.class);
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class);
            ...
            TransactionInput transactionInput = new TransactionInput(transactionMock3, byteArray2, transactionOutPointMock);
            List<TransactionInput> transactionInputList = new ArrayList<>();
            transactionInputList.add(transactionInput);
            doReturn(transactionInputList).when(txMock3).getInputs();
            doNothing().when(txMock4).clearInputs();
            ...
            TransactionInput transactionInput2 = new TransactionInput(transactionMock4, byteArray3, transactionOutPointMock4, coinMock4);
            List<TransactionInput> transactionInputList2 = new ArrayList<>();
            transactionInputList2.add(transactionInput2);
            doReturn(transactionInputList2).when(txMock6).getInputs();
            doReturn(coinMock5).when(txMock7).getInputSum();
            doReturn(coinMock6).when(txMock8).getOutputSum();
            doReturn(coinMock7).when(coinMock6).subtract(coinMock5);
            List<TransactionOutput> transactionOutputList3 = new ArrayList<>();
            transactionOutputList3.add(transactionOutputMock2);
            doReturn(transactionOutputList3).when(txMock9).getOutputs();
            doReturn(scriptMock).when(transactionOutputMock2).getScriptPubKey();
            byte[] byteArray4 = new byte[]{};
            TransactionInput transactionInput3 = new TransactionInput(transactionMock5, byteArray4, transactionOutPointMock5);
            List<TransactionInput> transactionInputList3 = new ArrayList<>();
            transactionInputList3.add(transactionInput3);
            doReturn(transactionInputList3).when(txMock10).getInputs();
            List<TransactionOutput> transactionOutputList4 = new ArrayList<>();
            doReturn(transactionOutputList4).when(transactionMock).getOutputs();
            thrown.expect(IllegalStateException.class);
            //Act Statement(s)
            target.completeTx(sendRequest);
            //Assert statement(s)
            ...
            verify(txMock9).getOutputs();
            verify(transactionOutputMock2).getScriptPubKey();
            verify(txMock10).getInputs();
            verify(transactionMock).getOutputs();
        }
    }
    ...
    public void completeTxWhenInputsStreamIsEmptyNoneMatchIGetOutpointEqualsOutputGetOutPointForIsEmptyAndReThrowsIllegalStateException() throws InsufficientMoneyException, CompletionException, ScriptException {
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class);
            ...
            doReturn(transactionOutputList4).when(txMock10).getOutputs();
            doReturn(false).when(transactionOutputMock3).isDust();
            byte[] byteArray4 = new byte[]{};
            TransactionInput transactionInput3 = new TransactionInput(transactionMock5, byteArray4, transactionOutPointMock3);
            List<TransactionInput> transactionInputList3 = new ArrayList<>();
            transactionInputList3.add(transactionInput3);
            doReturn(transactionInputList3).when(transactionMock).getInputs();
            thrown.expect(IllegalStateException.class);
            //Act Statement(s)
            target.completeTx(sendRequest);
            //Assert statement(s)
            ...
            verify(txMock9).getOutputs();
            verify(transactionOutputMock2).getScriptPubKey();
            verify(txMock10).getOutputs();
            verify(transactionOutputMock3).isDust();
            verify(transactionMock).getInputs();
        }
    }

    //Sapient generated method id: ${c775bca9-ab66-32e1-b265-e9a22bbbefc0}
    @Test()
    public void completeTxWhenAdjustOutputDownwardsForFeeNotReqTxBestCoinSelectionReqFeePerKbReqEnsu4ThrowsWalletCouldNotAdjustDownwards() throws InsufficientMoneyException, CompletionException, ScriptException {
        ...
        Transaction txMock = mock(Transaction.class);
        Transaction txMock2 = mock(Transaction.class);
        Coin coinMock9 = mock(Coin.class);
        ...
        Transaction transactionMock3 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock4 = mock(TransactionOutPoint.class);
        Coin coinMock10 = mock(Coin.class);
        Transaction txMock7 = mock(Transaction.class);
        Coin coinMock11 = mock(Coin.class);
        Transaction txMock8 = mock(Transaction.class);
        Coin coinMock12 = mock(Coin.class);
        Coin coinMock13 = mock(Coin.class);
        Transaction txMock9 = mock(Transaction.class);
        TransactionOutput transactionOutputMock5 = mock(TransactionOutput.class);
        Transaction txMock10 = mock(Transaction.class);
        Transaction transactionMock4 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock5 = mock(TransactionOutPoint.class);
        Transaction txMock11 = mock(Transaction.class);
        TransactionOutput transactionOutputMock6 = mock(TransactionOutput.class);
        Transaction txMock12 = mock(Transaction.class);
        TransactionOutput transactionOutputMock7 = mock(TransactionOutput.class);
        Transaction txMock13 = mock(Transaction.class);
        ...
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class);
            ...
            autoCloseableMocks = MockitoAnnotations.openMocks(this);
            List<TransactionOutput> transactionOutputList3 = new ArrayList<>();
            doReturn(transactionOutputList3).when(txMock).getOutputs();
            doReturn(coinMock9).when(txMock2).getOutputSum();
            doReturn("return_of_toFriendlyString1").when(coinMock9).toFriendlyString();
            doReturn("return_of_toFriendlyString1").when(coinMock).toFriendlyString();
            List<TransactionOutput> transactionOutputList4 = new ArrayList<>();
            transactionOutputList4.add(transactionOutputMock4);
            doReturn(transactionOutputList4).when(target).calculateAllSpendCandidates(true, false);
            ...
            doReturn(transactionInputMock).when(txMock5).addInput((TransactionInput) null);
            byte[] byteArray2 = new byte[]{};
            TransactionInput transactionInput2 = new TransactionInput(transactionMock3, byteArray2, transactionOutPointMock4, coinMock10);
            List<TransactionInput> transactionInputList2 = new ArrayList<>();
            transactionInputList2.add(transactionInput2);
            doReturn(transactionInputList2).when(txMock6).getInputs();
            doReturn(coinMock11).when(txMock7).getInputSum();
            doReturn(coinMock12).when(txMock8).getOutputSum();
            doReturn(coinMock13).when(coinMock12).subtract(coinMock11);
            List<TransactionOutput> transactionOutputList5 = new ArrayList<>();
            transactionOutputList5.add(transactionOutputMock5);
            doReturn(transactionOutputList5).when(txMock9).getOutputs();
            doReturn(scriptMock2).when(transactionOutputMock5).getScriptPubKey();
            byte[] byteArray3 = new byte[]{};
            TransactionInput transactionInput3 = new TransactionInput(transactionMock4, byteArray3, transactionOutPointMock5);
            List<TransactionInput> transactionInputList3 = new ArrayList<>();
            transactionInputList3.add(transactionInput3);
            doReturn(transactionInputList3).when(txMock10).getInputs();
            List<TransactionOutput> transactionOutputList6 = new ArrayList<>();
            transactionOutputList6.add(transactionOutputMock6);
            doReturn(transactionOutputList6).when(txMock11).getOutputs();
            doReturn(coinMock4).when(networkMock).maxMoney();
            doReturn(transactionOutputMock7).when(txMock12).getOutput(0L);
            doNothing().when(transactionOutputMock7).setValue(coinMock5);
            doReturn(transactionInputMock2).when(txMock13).addInput(transactionOutputMock);
            ...
            verify(txMock).getOutputs();
            verify(txMock2).getOutputSum();
            verify(coinMock9).toFriendlyString();
            verify(coinMock).toFriendlyString();
            verify(target).calculateAllSpendCandidates(true, false);
            ...
            verify(txMock7).getInputSum();
            verify(txMock8).getOutputSum();
            verify(coinMock12).subtract(coinMock11);
            verify(txMock9).getOutputs();
            verify(transactionOutputMock5).getScriptPubKey();
            verify(txMock10).getInputs();
            verify(txMock11).getOutputs();
            verify(networkMock).maxMoney();
            verify(txMock12).getOutput(0L);
            verify(transactionOutputMock7).setValue(coinMock5);
            verify(txMock13).addInput(transactionOutputMock);
        }
    }

    //Sapient generated method id: ${cd6db877-03a8-3fb5-b41c-4b6aee40e846}
    @Test()
    public void completeTxWhenSizeGreaterThanTransactionMAX_STANDARD_TX_SIZEThrowsWalletExceededMaxTransactionSize() throws InsufficientMoneyException, CompletionException, ScriptException, BadWalletEncryptionKeyException {
        ...
        Transaction txMock13 = mock(Transaction.class);
        TransactionInput transactionInputMock2 = mock(TransactionInput.class);
        Transaction txMock14 = mock(Transaction.class);
        try (MockedStatic<ScriptPattern> scriptPattern = mockStatic(ScriptPattern.class);
             MockedStatic<DefaultCoinSelector> defaultCoinSelector = mockStatic(DefaultCoinSelector.class);
             MockedStatic<AddressParser> addressParser = mockStatic(AddressParser.class);
             MockedStatic<NetworkParameters> networkParameters = mockStatic(NetworkParameters.class)) {
            ...
            List<TransactionOutput> transactionOutputList3 = new ArrayList<>();
            doReturn(transactionOutputList3).when(txMock).getOutputs();
            doReturn(coinMock7).when(txMock2).getOutputSum();
            doReturn("return_of_toFriendlyString1").when(coinMock7).toFriendlyString();
            doReturn("return_of_toFriendlyString1").when(coinMock).toFriendlyString();
            List<TransactionOutput> transactionOutputList4 = new ArrayList<>();
            transactionOutputList4.add(transactionOutputMock3);
            doReturn(transactionOutputList4).when(target).calculateAllSpendCandidates(true, true);
            ...
            doReturn(coinMock8).when(transactionOutputMock3).getValue();
            ...
            doReturn(transactionInputMock).when(txMock5).addInput((TransactionInput) null);
            byte[] byteArray3 = new byte[]{};
            TransactionInput transactionInput2 = new TransactionInput(transactionMock4, byteArray3, transactionOutPointMock4, coinMock9);
            List<TransactionInput> transactionInputList2 = new ArrayList<>();
            transactionInputList2.add(transactionInput2);
            doReturn(transactionInputList2).when(txMock6).getInputs();
            doReturn(coinMock10).when(txMock7).getInputSum();
            doReturn(coinMock11).when(txMock8).getOutputSum();
            doReturn(coinMock12).when(coinMock11).subtract(coinMock10);
            List<TransactionOutput> transactionOutputList5 = new ArrayList<>();
            transactionOutputList5.add(transactionOutputMock4);
            doReturn(transactionOutputList5).when(txMock9).getOutputs();
            doReturn(scriptMock2).when(transactionOutputMock4).getScriptPubKey();
            byte[] byteArray4 = new byte[]{};
            TransactionInput transactionInput3 = new TransactionInput(transactionMock5, byteArray4, transactionOutPointMock5);
            List<TransactionInput> transactionInputList3 = new ArrayList<>();
            transactionInputList3.add(transactionInput3);
            doReturn(transactionInputList3).when(txMock10).getInputs();
            List<TransactionOutput> transactionOutputList6 = new ArrayList<>();
            transactionOutputList6.add(transactionOutputMock5);
            doReturn(transactionOutputList6).when(txMock11).getOutputs();
            doReturn(coinMock4).when(networkMock).maxMoney();
            doReturn(transactionOutputMock6).when(txMock12).getOutput(0L);
            doNothing().when(transactionOutputMock6).setValue(coinMock5);
            doReturn(transactionInputMock2).when(txMock13).addInput(transactionOutputMock);
            doNothing().when(txMock14).shuffleOutputs();
            ...
            verify(txMock7).getInputSum();
            verify(txMock8).getOutputSum();
            verify(coinMock11).subtract(coinMock10);
            verify(txMock9).getOutputs();
            verify(transactionOutputMock4).getScriptPubKey();
            verify(txMock10).getInputs();
            verify(txMock11).getOutputs();
            verify(networkMock).maxMoney();
            verify(txMock12).getOutput(0L);
            verify(transactionOutputMock6).setValue(coinMock5);
            verify(txMock13).addInput(transactionOutputMock);
            verify(txMock14).shuffleOutputs();
            verify(target).signTransaction((SendRequest) any());
            verify(transactionMock).messageSize();
        }
    }

    //Sapient generated method id: ${bed1c73d-646a-33b4-a10d-55dd990dcc41}
    @Test()
    public void completeTxWhenSizeNotGreaterThanTransactionMAX_STANDARD_TX_SIZE() throws InsufficientMoneyException, CompletionException, ScriptException, BadWalletEncryptionKeyException, UTXOProviderException {
        ...
        TransactionOutput transactionOutputMock4 = mock(TransactionOutput.class);
        Transaction txMock10 = mock(Transaction.class);
        Transaction transactionMock6 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock5 = mock(TransactionOutPoint.class);
        Transaction txMock11 = mock(Transaction.class);
        TransactionOutput transactionOutputMock5 = mock(TransactionOutput.class);
        Transaction txMock12 = mock(Transaction.class);
        ...
        TransactionInput transactionInputMock2 = mock(TransactionInput.class);
        Transaction txMock14 = mock(Transaction.class);
        Transaction txMock15 = mock(Transaction.class);
        try (MockedStatic<Context> context = mockStatic(Context.class);
            ...
            doReturn(transactionOutPointMock, transactionOutPointMock2, transactionOutPointMock3).when(transactionOutputMock3).getOutPointFor();
            byte[] byteArray2 = new byte[]{};
            TransactionInput transactionInput = new TransactionInput(transactionMock4, byteArray2, transactionOutPointMock);
            List<TransactionInput> transactionInputList = new ArrayList<>();
            transactionInputList.add(transactionInput);
            doReturn(transactionInputList).when(txMock3).getInputs();
            doNothing().when(txMock4).clearInputs();
            doReturn(transactionInputMock).when(txMock5).addInput((TransactionInput) null);
            byte[] byteArray3 = new byte[]{};
            TransactionInput transactionInput2 = new TransactionInput(transactionMock5, byteArray3, transactionOutPointMock4, coinMock9);
            List<TransactionInput> transactionInputList2 = new ArrayList<>();
            transactionInputList2.add(transactionInput2);
            doReturn(transactionInputList2).when(txMock6).getInputs();
            doReturn(coinMock10).when(txMock7).getInputSum();
            ...
            doReturn(scriptMock2).when(transactionOutputMock4).getScriptPubKey();
            byte[] byteArray4 = new byte[]{};
            TransactionInput transactionInput3 = new TransactionInput(transactionMock6, byteArray4, transactionOutPointMock5);
            List<TransactionInput> transactionInputList3 = new ArrayList<>();
            transactionInputList3.add(transactionInput3);
            doReturn(transactionInputList3).when(txMock10).getInputs();
            List<TransactionOutput> transactionOutputList6 = new ArrayList<>();
            ...
            doNothing().when(txMock14).shuffleOutputs();
            doNothing().when(target).signTransaction((SendRequest) any());
            doReturn(0).when(txMock15).messageSize();
            //Act Statement(s)
            target.completeTx(sendRequest);
            //Assert statement(s)
            verify(coinMock).multiply(0L);
    ...
    public void connectInputsWhenDefaultBranch() throws ScriptException {
        ...
        Transaction transactionMock6 = mock(Transaction.class);
        Coin coinMock6 = mock(Coin.class);
        Transaction transactionMock7 = mock(Transaction.class);
        Coin coinMock7 = mock(Coin.class);
        Transaction transactionMock8 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock = mock(TransactionOutPoint.class);
        Transaction transactionMock9 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock2 = mock(TransactionOutPoint.class);
        Transaction transactionMock10 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock3 = mock(TransactionOutPoint.class);
        Transaction transactionMock11 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock4 = mock(TransactionOutPoint.class);
        Transaction transactionMock12 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock5 = mock(TransactionOutPoint.class);
        Transaction transactionMock13 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock6 = mock(TransactionOutPoint.class);
        Transaction transactionMock14 = mock(Transaction.class);
        TransactionOutPoint transactionOutPointMock7 = mock(TransactionOutPoint.class);
        try (MockedStatic<StreamUtils> streamUtils = mockStatic(StreamUtils.class)) {
            streamUtils.when(() -> StreamUtils.toUnmodifiableList()).thenReturn(collectorMock);
            byte[] byteArray = new byte[]{};
            ...
            byte[] byteArray3 = new byte[]{};
            TransactionOutput transactionOutput3 = new TransactionOutput(transactionMock3, coinMock3, byteArray3);
            byte[] byteArray4 = new byte[]{};
            TransactionOutput transactionOutput4 = new TransactionOutput(transactionMock4, coinMock4, byteArray4);
            byte[] byteArray5 = new byte[]{};
            TransactionOutput transactionOutput5 = new TransactionOutput(transactionMock5, coinMock5, byteArray5);
            byte[] byteArray6 = new byte[]{};
            TransactionOutput transactionOutput6 = new TransactionOutput(transactionMock6, coinMock6, byteArray6);
            byte[] byteArray7 = new byte[]{};
            TransactionOutput transactionOutput7 = new TransactionOutput(transactionMock7, coinMock7, byteArray7);
            List<TransactionOutput> transactionOutputList = new ArrayList<>();
            transactionOutputList.add(transactionOutput);
            transactionOutputList.add(transactionOutput2);
            transactionOutputList.add(transactionOutput3);
            transactionOutputList.add(transactionOutput4);
            transactionOutputList.add(transactionOutput5);
            transactionOutputList.add(transactionOutput6);
            transactionOutputList.add(transactionOutput7);
            byte[] byteArray8 = new byte[]{};
            Coin coin = Coin.valueOf(0L);
            TransactionInput transactionInput = new TransactionInput(transactionMock8, byteArray8, transactionOutPointMock, coin);
            byte[] byteArray9 = new byte[]{};
            Coin coin2 = Coin.valueOf(0L);
            TransactionInput transactionInput2 = new TransactionInput(transactionMock9, byteArray9, transactionOutPointMock2, coin2);
            byte[] byteArray10 = new byte[]{};
            Coin coin3 = Coin.valueOf(0L);
            TransactionInput transactionInput3 = new TransactionInput(transactionMock10, byteArray10, transactionOutPointMock3, coin3);
            byte[] byteArray11 = new byte[]{};
            Coin coin4 = Coin.valueOf(0L);
            TransactionInput transactionInput4 = new TransactionInput(transactionMock11, byteArray11, transactionOutPointMock4, coin4);
            byte[] byteArray12 = new byte[]{};
            Coin coin5 = Coin.valueOf(0L);
            TransactionInput transactionInput5 = new TransactionInput(transactionMock12, byteArray12, transactionOutPointMock5, coin5);
            byte[] byteArray13 = new byte[]{};
            Coin coin6 = Coin.valueOf(0L);
            TransactionInput transactionInput6 = new TransactionInput(transactionMock13, byteArray13, transactionOutPointMock6, coin6);
            byte[] byteArray14 = new byte[]{};
            Coin coin7 = Coin.valueOf(0L);
            TransactionInput transactionInput7 = new TransactionInput(transactionMock14, byteArray14, transactionOutPointMock7, coin7);
            List<TransactionInput> transactionInputList = new ArrayList<>();
            transactionInputList.add(transactionInput);
            transactionInputList.add(transactionInput2);
            transactionInputList.add(transactionInput3);
            transactionInputList.add(transactionInput4);
            transactionInputList.add(transactionInput5);
            transactionInputList.add(transactionInput6);
            transactionInputList.add(transactionInput7);
            //Act Statement(s)
            List<TransactionInput> result = Wallet.connectInputs(transactionOutputList, transactionInputList);
            List<TransactionInput> transactionInputTransactionInputListList = new ArrayList<>();
            transactionInputTransactionInputListList.add(transactionInput);
            transactionInputTransactionInputListList.add(transactionInput2);
            transactionInputTransactionInputListList.add(transactionInput3);
            transactionInputTransactionInputListList.add(transactionInput4);
            transactionInputTransactionInputListList.add(transactionInput5);
            transactionInputTransactionInputListList.add(transactionInput6);
            transactionInputTransactionInputListList.add(transactionInput7);
            //Assert statement(s)
            assertThat(result.size(), equalTo(0));
            assertThat(transactionInputList.size(), equalTo(transactionInputTransactionInputListList.size()));
            assertThat(transactionInputList, containsInRelativeOrder(transactionInputTransactionInputListList.toArray()));
            streamUtils.verify(() -> StreamUtils.toUnmodifiableList(), atLeast(1));
        }
    }
    ...
    public void signTransactionWhenConnectedOutputIsNotNullAndCaughtScriptExceptionAndSignersIsNotEmptyAndSignerNotSignInputsProposalMa() throws BadWalletEncryptionKeyException, ScriptException {
        ...
        try (MockedStatic<DefaultCoinSelector> defaultCoinSelector = mockStatic(DefaultCoinSelector.class);
            ...
            doReturn(redeemData).when(transactionInputMock2).getConnectedRedeemData((DecryptingKeyBag) any());
            ...
            verify(transactionInputMock2).getWitness();
            verify(transactionInputMock2).getConnectedRedeemData((DecryptingKeyBag) any());
    ...
    //Sapient generated method id: ${3b14c606-e40a-30c7-8bac-9fe54d3b6b3d}
    @Test()
