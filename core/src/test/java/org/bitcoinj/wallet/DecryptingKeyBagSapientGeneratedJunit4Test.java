...
public class DecryptingKeyBagSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${3e0844fc-0454-36bc-ad62-c03333a4359b}, hash: 7C1BA0B3ADD0DCF11885C0A4D3FD2C9B
    @Test()
    ...
    //Sapient generated method id: ${78bbd9b7-7717-3f50-9697-12e79ca26734}, hash: A04577C3571EE4DE083C1ACA0354CC4E
    @Test()
    public void findKeyFromPubKeyHashWhenKeyNotIsEncrypted() {
        ...
        verify(targetMock).findKeyFromPubKeyHash(byteArray, ScriptType.P2PKH);
        verify(eCKeyMock, atLeast(1)).isEncrypted();
    }

    //Sapient generated method id: ${abbaf156-aef6-3779-a475-04cbad1d73cf}, hash: 0A9D8BE931C1CDB326D33BC117FCB7D5
    @Test()
    ...
    //Sapient generated method id: ${82511563-8c7c-3127-9d47-29a79df21ef4}, hash: 80154DF4F3DC8CD37B8EFDDA0F2DE31E
    @Test()
    ...
    //Sapient generated method id: ${3d7d7bf6-29c5-3904-a6b8-511994e0c3a7}, hash: 84D42988E93D12AA69304F88611C6A2E
    @Test()
    ...
    //Sapient generated method id: ${4ecc54fc-dd2e-3fa8-80db-d0e24e14dd0e}, hash: 3EE2882F2D6439A33C308322636A5798
    @Test()
    ...
    //Sapient generated method id: ${1efcc87a-1fa8-39ea-ba9b-2eacdc689274}, hash: 873DBE897ECEC0CECA02CD836156CC25
    @Test()
    ...
    //Sapient generated method id: ${5df3db22-c0f6-37ab-84c0-e993c59b2f74}, hash: A53099E0EEFA6576A2CCA78877BDA60D
    @Test()
    ...
    //Sapient generated method id: ${0fb967ea-5cf9-3b00-b91a-83e3da7223c3}, hash: 421277C531458F7D64AC34C93E2C34F3
    @Ignore()
    @Test()
    public void findRedeemDataFromScriptHashWhenKeyIsNull() {
        ...
        try (MockedStatic<RedeemData> redeemData = mockStatic(RedeemData.class)) {
            ...
            byte[] byteArray = new byte[]{};
            doReturn(redeemData2).when(targetMock).findRedeemDataFromScriptHash(byteArray);
            //Act Statement(s)
    ...
    //Sapient generated method id: ${e32c1ee9-0c0e-3c15-8bcc-1afa0d2f3717}, hash: 30EF17A56E6DC046F9C794EAF5A906FA
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${3c1f3b56-8350-39d8-a8d3-99a55c0bd742}, hash: 5E61489E0AFC1B77F9FA2E12AB490C85
    @Test()
    public void findRedeemDataFromScriptHashWhenAesKeyIsNullThrowsECKeyKeyIsEncryptedException() {
        ...
        byte[] byteArray = new byte[]{};
        doReturn(redeemData).when(targetMock).findRedeemDataFromScriptHash(byteArray);
        doReturn(true).when(eCKeyMock).isEncrypted();
        thrown.expect(ECKey.KeyIsEncryptedException.class);
        //Act Statement(s)
    ...
    //Sapient generated method id: ${a6d40181-ac68-3236-a9df-d3031ae980dc}, hash: A334F935399FC9195B6760F5A054FBC0
    @Ignore()
    @Test()
