...
public class WalletProtobufSerializerSapientGeneratedJunit4Test {
    ...
    public void walletToProtoWhenSwitchTxGetPurposeCaseDefaultThrowsRuntimeException() {
        ...
        try (MockedStatic<ByteString> byteString = mockStatic(ByteString.class);
            ...
            doReturn(iterableMock).when(walletMock).getWalletTransactions();
    ...
    public void walletToProtoWhenWalletGetTagsEntrySetIsNotEmpty() {
        ...
        try (MockedStatic<Protos.Tag> protosTag = mockStatic(Protos.Tag.class);
            ...
            Instant instant2 = (Instant) Instant.ofEpochSecond(1700000000);
            ...
            doReturn("V").when(walletExtensionMock).getWalletExtensionID();
            ...
            stringByteStringMap.put("X", byteString2Mock);
            ...
            Protos.Extension.Builder builder3 = protosExtensionBuilderMock.setId("V");
            doReturn(builder3).when(protosExtensionBuilderMock).setId("V");
            ...
            Protos.Tag.Builder builder9 = protosTagBuilderMock2.setTag("X");
            doReturn(builder9).when(protosTagBuilderMock2).setTag("X");
            WalletProtobufSerializer target = new WalletProtobufSerializer(walletProtobufSerializerWalletFactoryMock);
            //Act Statement(s)
            ...
            verify(protosExtensionBuilderMock).setId("V");
            ...
            verify(protosTagBuilderMock2).setTag("X");
        }
    }
