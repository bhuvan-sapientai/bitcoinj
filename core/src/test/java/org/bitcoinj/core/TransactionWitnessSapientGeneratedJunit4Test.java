...
public class TransactionWitnessSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${848b5418-f65f-3400-a9e9-12dec4a0a36f}, hash: A0429F8BCB97B086A5D2AAA157DC4389
    @Test()
    ...
    //Sapient generated method id: ${fe971f55-5e80-3116-bec7-96642e064bb6}, hash: BF523B8380E30318F843F61CBD85529D
    @Test()
    ...
    //Sapient generated method id: ${d46e6454-f8cb-3644-a826-e4429686af60}, hash: EEB00270716030404277DCFF1B0747A4
    @Test()
    ...
    //Sapient generated method id: ${946fac9c-df07-3dcd-9b8a-4a56705e4fba}, hash: C62E066E06AEA516E1E1DE205CD3F9F5
    @Test()
    ...
    //Sapient generated method id: ${2d9e451b-59ca-3da9-a6c7-f80da9bfa12e}, hash: 3625B5F5C6538C43BA71C180BA49FADF
    @Test()
    public void of1Test() {
        //Arrange Statement(s)
        try (MockedStatic<TransactionWitness> transactionWitness = mockStatic(TransactionWitness.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${d7d7c181-85f8-3d2b-b5a1-c1ddd262297c}, hash: 061139E4B8BECEC684EE03E634B5A60E
    @Test()
    ...
    //Sapient generated method id: ${91c4a99d-7a18-35fa-926f-93c6fa805429}, hash: 13DB9B993E050BF33E6BD791A09574DC
    @Test()
    ...
    //Sapient generated method id: ${a2bf3b9b-c78f-381f-a368-c4049790a3f0}, hash: CD1BB371899188BD8C95547CF472BB3E
    @Test()
    ...
    //Sapient generated method id: ${46390a57-25fa-372f-b5f9-33562d858327}, hash: E5770C325CC240F4A6481AB8CA665882
    @Ignore()
    @Test()
    public void writeWhenPushesIsNotEmpty() throws BufferOverflowException {
        ...
        try (MockedStatic<Buffers> buffers = mockStatic(Buffers.class);
            ...
            buffers.when(() -> Buffers.writeLengthPrefixedBytes((ByteBuffer) any(), eq(byteArray2))).thenReturn(byteBuffer3);
            List<byte[]> byteList = new ArrayList<>();
            byteList.add(byteArray);
            byteList.add(byteArray2);
            TransactionWitness target = TransactionWitness.of(byteList);
    ...
    //Sapient generated method id: ${9d328af1-2293-3544-bbbc-a0683c1f9fbe}, hash: 0929221DACBE139D32BCD4713590ADE3
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${198e0ef0-e6d5-3daa-9f95-2e02390f74a3}, hash: E8E116E2B54DB0F3C3BE2E03945AF992
    @Test()
    public void messageSizeWhenPushesIsNotEmpty() {
        ...
        try (MockedStatic<VarInt> varInt = mockStatic(VarInt.class)) {
            varInt.when(() -> VarInt.sizeOf(3L)).thenReturn(1).thenReturn(11).thenReturn(1).thenReturn(1);
            ...
            varInt.verify(() -> VarInt.sizeOf(3L), atLeast(4));
        }
    }

    //Sapient generated method id: ${435d64f5-8fca-31bf-b014-13944bac4d4c}, hash: 788CF44D9608BBAA0001793CF13EA38D
    @Test()
    ...
    //Sapient generated method id: ${6ecbda3c-3734-3c94-b31a-d398eb9ec8be}, hash: 95F4428E068243211CE03C85551F42A6
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${065a56d0-4ec0-38eb-a24f-b51c11ce350a}, hash: 7EFB8164D93B15854E04FAD8F6CD271D
    @Ignore()
    @Test()
