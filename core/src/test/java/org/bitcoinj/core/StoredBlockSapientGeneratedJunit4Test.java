...
public class StoredBlockSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${92dc7974-0020-34ea-89d0-57030ad2fe67}
    @Test()
    public void serializeCompactWhenChainWorkBytesLengthLessThanCHAIN_WORK_BYTES() {
        ...
        List list = new ArrayList<>();
        Block block = new Block(0L, sha256HashMock, sha256HashMock2, instant, 0L, 0L, list);
        StoredBlock target = spy(new StoredBlock(block, new BigInteger("1000000000000"), 500));
    ...
    public void toStringTest() {
        ...
        doReturn("String getHashAsString value").when(blockMock).getHashAsString();
