...
public class VersionMessageSapientGeneratedJunit4Test {
    ...
    byteUtils.when(() -> ByteUtils.writeInt64LE(eq(1704367514L), (OutputStream) any())).thenAnswer((Answer<Void>) invocation -> null);
    byte[] byteArray = new byte[] {};
    ...
    VersionMessage target = new VersionMessage(paramsMock, 0);
    ...
    byteUtils.verify(() -> ByteUtils.writeInt64LE(eq(1704367514L), (OutputStream) any()));
