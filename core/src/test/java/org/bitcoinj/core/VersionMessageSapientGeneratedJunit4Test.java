...
public class VersionMessageSapientGeneratedJunit4Test {
    ...
    private final InetSocketAddress receivingAddrMock = mock(InetSocketAddress.class, "receivingAddr");
    ...
    //Sapient generated method id: ${7ec5d0ac-6390-3fe5-a724-28b80dd29de6}, hash: D225E6E9A97443855F12A2459C1C65E6
    @Test()
    ...
    //Sapient generated method id: ${d7d57af3-a748-35ec-8d28-8549802898a1}, hash: 480BCD843FFB0151BC674CD3D9BA38C6
    @Test()
    ...
    //Sapient generated method id: ${d4f99154-84c3-3cd3-9346-abd2d205fdef}, hash: 9ED2E38AF37589587F3EBE51DAD109E1
    @Ignore()
    @Test()
    public void readWhenPayloadGetNotEquals0() throws Throwable {
        ...
        //Arrange Statement(s)
        Services servicesMock = mock(Services.class);
        Services servicesMock2 = mock(Services.class, "Services");
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class);
             MockedStatic<Buffers> buffers = mockStatic(Buffers.class);
             MockedStatic<PeerAddress> peerAddress = mockStatic(PeerAddress.class);
             MockedStatic<Services> services = mockStatic(Services.class)) {
    ...
    //Sapient generated method id: ${9cd4c033-61ee-3be5-a04e-67c09571e01d}, hash: ECC815979D2F5128F78C2CAC067B78E3
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${3e2ccb4e-d64b-361e-8c0b-a7f5ca47d588}, hash: 4BFBE97DC775E456F97E47825F7CE533
    @Test()
    ...
    //Sapient generated method id: ${aa9352bb-8003-3648-89bf-8ac79fc33136}, hash: 539368DDA47CDF06FB3D81CDFC59D4ED
    @Test()
    ...
    //Sapient generated method id: ${6fe58293-6ecb-365b-9a21-75d60574bea7}, hash: 6D8CA13C591D0194ACD4609A1B0BAB4E
    @Test()
    ...
    Services services4 = Services.none();
    services.when(() -> Services.none()).thenReturn(services3).thenReturn(services4);
    ...
    target = new VersionMessage(networkParameters, 1);
    autoCloseableMocks = MockitoAnnotations.openMocks(this);
    doReturn(0).when(receivingAddrMock).getPort();
    ...
    byteUtils.verify(() -> ByteUtils.writeInt32LE(eq(70013), (OutputStream) any()), atLeast(1));
    peerAddress.verify(() -> PeerAddress.mapIntoIPv6(byteArray2), atLeast(1));
    byteUtils.verify(() -> ByteUtils.writeInt16BE(eq(0), (OutputStream) any()), atLeast(1));
    byteUtils.verify(() -> ByteUtils.writeInt32LE(eq(0), (OutputStream) any()), atLeast(2));
    varInt.verify(() -> VarInt.of(24L), atLeast(1));
    byteUtils.verify(() -> ByteUtils.writeInt32LE(eq(1L), (OutputStream) any()), atLeast(1));
    verify(receivingAddrMock, atLeast(1)).getPort();
}*/
    }

    //Sapient generated method id: ${d5bd5bd8-2e54-3633-b644-e8875aa2f992}, hash: 3B9F2C4B984DE60F0C50529870ACA853
    @Ignore()
    @Test()
    public void toStringWhenRelayTxesBeforeFilter() {
        ...
        NetworkParameters paramsMock = mock(NetworkParameters.class);
        doReturn(0).when(paramsMock).getPort();
        target = new VersionMessage(paramsMock, 2);
        autoCloseableMocks = MockitoAnnotations.openMocks(this);
        //Act Statement(s)
        String result = target.toString();
        //Assert statement(s)
        assertThat(result, equalTo("\nclient version: 70013\n\ntime:           2024-04-04T06:51:18Z\nreceiving svc:  \nreceiving addr: B\nsub version:    /bitcoinj:0.17-SNAPSHOT/\nbest height:    2\ndelay tx relay: false\n"));
        verify(paramsMock).getPort();
    }

    //Sapient generated method id: ${58212c05-0c08-317d-b2fb-ab0a548951e7}, hash: 08AFE956C00ADCF4C2775303E8FD9372
    @Test()
    ...
    //Sapient generated method id: ${636ef9a2-f336-3a09-bf43-9d48f229ef7f}, hash: D44E7FABEA8B83B75B561106287B1526
    @Test()
    ...
    //Sapient generated method id: ${f9a94092-d738-3d71-b150-0ac3bbe2dbc5}, hash: CDA916626A4AA4BD8FC63C989D969915
    @Test()
    ...
    //Sapient generated method id: ${8b0b45f5-d3a8-35f3-99d5-48203ce188bc}, hash: 7DE7B992B0811EF6C71AB09A3332406B
    @Test()
    ...
    //Sapient generated method id: ${f1b4fb54-b24a-3e81-b913-9d81680266f6}, hash: 09FDE7C7448AFE79CDF04730E60CC9E9
    @Test()
    ...
    //Sapient generated method id: ${761cf6fa-1520-3ff5-8c53-855ee388bdee}, hash: 21BDC39E438162C0A4642ADEC743A239
    @Test()
    ...
    //Sapient generated method id: ${0c994290-e94b-35b1-a267-e7fe4838bd49}, hash: 6C55D2EE0FEF3EEC37445F9BC88166F8
    @Test()
    ...
    //Sapient generated method id: ${2337c104-de1f-364d-8ce3-57eec55420af}, hash: 39177CACD597B9D212458CBCE718FCEF
    @Test()
