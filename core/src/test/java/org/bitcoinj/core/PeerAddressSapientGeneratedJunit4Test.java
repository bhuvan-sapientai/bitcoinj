...
public class PeerAddressSapientGeneratedJunit4Test {
    ...
    public void serializeTest() throws BufferOverflowException {
        ...
        doReturn(0).when(target).getMessageSize(0);
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(64);
    ...
    //Sapient generated method id: ${a62aeb0f-ad3d-3413-9ea5-1459537584f3}
    @Test()
    ...
    //Sapient generated method id: ${f725f5d2-5b15-31f0-bd89-6a8220f44ba5}
    @Test()
