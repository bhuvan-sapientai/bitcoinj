...
public class TransactionBroadcastSapientGeneratedJunit4Test {
    ...
    private final PeerGroup peerGroupMock = mock(PeerGroup.class, "peerGroupValue");

    private final ListenableCompletableFuture<List<Peer>> listenableCompletableFutureMock = mock(ListenableCompletableFuture.class);
    ...
    public void setProgressCallbackTest() throws Throwable {
        ...
        Transaction transaction = new Transaction();
        TransactionBroadcast target = spy(new TransactionBroadcast(peerGroupMock, transaction));
        TransactionBroadcast.ProgressCallback transactionBroadcastProgressCallbackMock = mock(TransactionBroadcast.ProgressCallback.class, "callbackValue");
    ...
    public void setProgressCallback1WhenNotShouldInvoke() throws Throwable {
        ...
        Transaction transaction = new Transaction();
        TransactionBroadcast target = new TransactionBroadcast(peerGroupMock, transaction);
        TransactionBroadcast.ProgressCallback transactionBroadcastProgressCallbackMock = mock(TransactionBroadcast.ProgressCallback.class, "callback_value");
        Executor executorMock = mock(Executor.class, "executor_value");
