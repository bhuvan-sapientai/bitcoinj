...
public class TransactionConfidenceSapientGeneratedJunit4Test {
    ...
    public void addEventListenerTest() {
        ...
        Executor executorMock = mock(Executor.class, "executorValue");
        TransactionConfidence.Listener transactionConfidenceListenerMock = mock(TransactionConfidence.Listener.class, "listenerValue");
