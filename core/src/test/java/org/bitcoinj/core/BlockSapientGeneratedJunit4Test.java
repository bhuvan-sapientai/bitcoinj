...
public class BlockSapientGeneratedJunit4Test {
    ...
    public void getTimeTest() {
        ...
        List<Transaction> transactionList = new ArrayList<>();
        Block target = spy(new Block(1L, sha256Hash, sha256Hash2, instant, 12345L, 67890L, transactionList));
    ...
    public void createNextBlock2Test() throws IOException {
        ...
        Block target = spy(new Block(123L, sha256Hash, sha256Hash2, instant, 456L, 789L, transactionList));
        Instant instant2 = Instant.ofEpochSecond(1700000000);
        doReturn(instant2).when(target).time();
        Address addressMock = mock(Address.class, "toValue");
