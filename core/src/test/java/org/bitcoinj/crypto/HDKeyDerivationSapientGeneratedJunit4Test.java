...
public class HDKeyDerivationSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${df36f5c5-24e9-331d-868c-0ca59c300dd6}
    @Test()
    ...
    //Sapient generated method id: ${e13ebcb2-943c-31dc-8491-f815809e7e5b}
    @Test()
    ...
    public void generateTest() {
         ...
         */
        //Arrange Statement(s)
        DeterministicKey deterministicKeyMock = mock(DeterministicKey.class, "solved_parent_value");
    ...
    //Sapient generated method id: ${7caaec38-9f62-3376-b906-1dec40a8a8cc}
    @Test()
    ...
    //Sapient generated method id: ${887ec1c5-4e77-3c6a-a90c-a73e31b851a7}
    @Test()
    ...
    //Sapient generated method id: ${5c8fc085-8e3a-313b-b2c6-3306aeb402e4}
    @Test()
    ...
    //Sapient generated method id: ${76460239-fd76-37ad-b40a-420b2d0f27e8}
    @Test()
    ...
    //Sapient generated method id: ${fd54074d-cfbf-3186-80df-7b0591849b7e}
    @Test()
    ...
    //Sapient generated method id: ${7bb40d3d-8ac4-3b6a-b022-d1ffdde5f124}
    @Test()
    ...
    //Sapient generated method id: ${5a30f159-34ae-39fc-af31-68be4cadcbd8}
    @Test()
    ...
    //Sapient generated method id: ${12397fc1-e9c9-340a-a96c-7061796d9eb4}
    @Test()
    ...
    //Sapient generated method id: ${919c2f68-b6e3-38df-93e8-91736c801fd2}
    @Test()
    ...
    //Sapient generated method id: ${f78da902-b321-35cd-bdf4-d1d5d8b549f6}
    @Test()
    public void deriveChildKeyBytesFromPublicWhenSwitchModeCaseWITH_INVERSIONAndPointNotEqualsECKeyCURVEGetCurveGetInfinity() throws HDDerivationException {
        ...
        try (MockedStatic<ECKey> eCKey = mockStatic(ECKey.class)) {
            ...
            ECPoint eCPoint = ECKey.publicPointFromPrivate(new BigInteger("97729218245822813695977438708406128673539638830045567634238910843951647959547"));
            eCKey.when(() -> ECKey.publicPointFromPrivate(new BigInteger("97729218245822813695977438708406128673539638830045567634238910843951647959547"))).thenReturn(eCPoint);
            //Act Statement(s)
            ...
            eCKey.verify(() -> ECKey.publicPointFromPrivate(new BigInteger("97729218245822813695977438708406128673539638830045567634238910843951647959547")), atLeast(1));
        }
    }
}
