...
public class HDPathSapientGeneratedJunit4Test {
    ...
    public void parsePathWhenNIsEmptyAndIsHard() {
        ...
        //stringList.add("\"0\"");
        //stringList.add("\"1\"");
        //doReturn(stringList).when(SEPARATOR_SPLITTERMock).splitToList("m/0/1");
        //Act Statement(s)
        //HDPath result = HDPath.parsePath("m/0/1");
        //ChildNumber childNumber = new ChildNumber(0, false);
        ...
        //Assert statement(s)
        //assertThat(result, equalTo(hDPath));
        //verify(SEPARATOR_SPLITTERMock).splitToList("m/0/1");
    }
    ...
    public void extendTest() {
        ...
        //ChildNumber[][] childNumberArray3 = new ChildNumber[][] { childNumber4 };
        //ChildNumber childNumber5 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray4 = new ChildNumber[][] { childNumber5 };
        ...
        //ChildNumber[][] childNumberArray6 = new ChildNumber[][] { childNumber6 };
        //ChildNumber childNumber7 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray7 = new ChildNumber[][] { childNumber7 };
        ...
        //Act Statement(s)
        //HDPath result = target.extend(childNumber3, childNumberArray);
        //ChildNumber childNumber8 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray9 = new ChildNumber[][] { childNumber8 };
        //ChildNumber childNumber9 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray10 = new ChildNumber[][] { childNumber9 };
        ...
        //ChildNumber[][] childNumberArray12 = new ChildNumber[][] { childNumber10 };
        //ChildNumber childNumber11 = new ChildNumber(0, false);
        //ChildNumber[][] childNumberArray13 = new ChildNumber[][] { childNumber11 };
    ...
    public void extend1Test() {
        ...
        ChildNumber childNumber4 = new ChildNumber(4);
        List<ChildNumber> childNumberList = new ArrayList<>();
        childNumberList.add(childNumber);
        childNumberList.add(childNumber2);
        childNumberList.add(childNumber3);
