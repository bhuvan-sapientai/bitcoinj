...
public class TorUtilsSapientGeneratedJunit4Test {
    ...
    public void decodeOnionUrlWhenOnionAddressLengthNotEquals32Plus2Plus1ThrowsIllegalArgumentException() {
         ...
         */
        //Arrange Statement(s)
        IllegalArgumentException illegalArgumentException = new IllegalArgumentException("unrecognizable length: ABCDEF");
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(illegalArgumentException.getMessage());
        //Act Statement(s)
        TorUtils.decodeOnionUrl("ABCDEF");
    }
    ...
    public void decodeOnionUrlWhenTorVersionNotEquals3ThrowsIllegalArgumentException() {
         ...
         */
        //Arrange Statement(s)
        IllegalArgumentException illegalArgumentException = new IllegalArgumentException("unknown version: ADEBFGC");
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(illegalArgumentException.getMessage());
        //Act Statement(s)
        TorUtils.decodeOnionUrl("ADEBFGC");
    }
