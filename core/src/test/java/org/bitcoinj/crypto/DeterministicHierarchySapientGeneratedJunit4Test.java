...
public class DeterministicHierarchySapientGeneratedJunit4Test {
    ...
    private final HDPath hDPathMock3 = mock(HDPath.class, "get_hDPath1");
    ...
    //Sapient generated method id: ${4706f091-c110-342a-8f50-cd57ec64202d}, hash: B068183FE1F9C4449F197A1120454D3F
    @Test()
    ...
    //Sapient generated method id: ${278d7fd4-a2c9-352f-ab36-f62c16594b92}, hash: A2B6E25B9D1940B4547331474126AEFB
    @Test()
    ...
    //Sapient generated method id: ${2bafa839-995b-3253-b961-8ad2c1102276}, hash: BD695A216FDCE2DE060F442037508E5F
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${f00a1a9a-b0c1-375f-9aa4-bb9ffe58a3f2}, hash: 5080F9C910031E1452EDE8DE1C7ACA43
    @Ignore()
    @Test()
    public void getWhenAbsolutePathSizeGreaterThan0() {
        ...
        try (MockedStatic<HDKeyDerivation> hDKeyDerivation = mockStatic(HDKeyDerivation.class);
            ...
            verify(keyMock, atLeast(2)).getPath();
            verify(hDPathMock, times(3)).size();
            verify(hDPathMock).subList(0, 0);
            verify(hDPathMock).get(0);
            verify(keyMock, atLeast(1)).getParent();
            verify(deterministicKeyMock).getPath();
            verify(keyMock, atLeast(1)).getChildNumber();
            hDPath.verify(() -> HDPath.M(anyList()));
    ...
    //Sapient generated method id: ${f74c6dbf-69f1-3014-85ef-06547feacf55}, hash: 55D4E815A330E380BBF0AF7B67BDF870
    @Test()
    ...
    //Sapient generated method id: ${6518e29b-f38f-3e8b-b3c8-111c93f9927a}, hash: 85C2CBFFF3FF1B78776347BC18629D7B
    @Test()
    ...
    //Sapient generated method id: ${40fc7af5-625c-3a83-a14b-2599ed1dfea5}, hash: A5A439D9C43B0141273D1C70126FB050
    @Test()
    ...
    //Sapient generated method id: ${514c68b2-346c-3a06-a3e4-20fb83054539}, hash: F4BFAC76CDD7DEA5DDCBB1545D5AE7DA
    @Test()
    ...
    //Sapient generated method id: ${1383cac1-67e1-3da3-9e08-583a63944d1e}, hash: 17AD4774078983BE9783A541FF7C75C9
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${09651aa6-0c86-3ab9-99e7-e3eb95b56ca6}, hash: FCC81CE592A0C92581DF606AB179A1B3
    @Test()
    ...
    //Sapient generated method id: ${7279f84e-b0a0-32b4-a1f7-0e36c86c05a3}, hash: 482525892757899B53190C7FE2304D9E
    @Test()
    ...
    //Sapient generated method id: ${bc074e57-33d7-30e4-9d2e-dbc423e9a448}, hash: 8DB8578FD5C1DF4DC5F3AAD36502B611
    @Test()
    ...
    //Sapient generated method id: ${2a8672b2-2ecd-3251-b270-144f691989dc}, hash: 14FA6B79496DCDFC0D1A6388126EF0E5
    @Test()
