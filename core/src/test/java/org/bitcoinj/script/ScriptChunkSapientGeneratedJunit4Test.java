...
public class ScriptChunkSapientGeneratedJunit4Test {
    ...
    public void equalsOpCodeWhenOpcodeEqualsThisOpcode() {
        ...
        ScriptChunk target = new ScriptChunk(10, byteArray);

        //Act Statement(s)
        boolean result = target.equalsOpCode(10);
    ...
    public void equalsOpCodeWhenOpcodeNotEqualsThisOpcode() {
        ...
        ScriptChunk target = new ScriptChunk(0, byteArray);
    ...
    public void isPushDataWhenOpcodeGreaterThanOP_16() {
        ...
        //Arrange Statement(s)
        byte[] byteArray = new byte[]{(byte) 1, (byte) 2, (byte) 3};
        ScriptChunk target = new ScriptChunk(20, byteArray);
    ...
    public void decodeOpNTest() {
        ...
        try (MockedStatic<Script> script = mockStatic(Script.class)) {
            script.when(() -> Script.decodeFromOpN(10)).thenReturn(2);
            byte[] byteArray = new byte[]{(byte) 1, (byte) 2, (byte) 3};
            ScriptChunk target = new ScriptChunk(10, byteArray);
            //Act Statement(s)
            ...
            script.verify(() -> Script.decodeFromOpN(10), atLeast(1));
        }
    }
    ...
    public void isShortestPossiblePushDataWhenDataIsNull() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            ...
            ScriptChunk target = spy(new ScriptChunk(1, (byte[]) null));
    ...
    public void isShortestPossiblePushDataWhenBAnd255Equals129AndOpcodeNotEqualsOP_1NEGATE() {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            preconditions.when(() -> Preconditions.checkState(false)).thenAnswer((Answer<Void>) invocation -> null);
            byte[] byteArray = new byte[]{(byte) -127};
            ScriptChunk target = spy(new ScriptChunk(129, byteArray));
            doReturn(false).when(target).isPushData();
            //Act Statement(s)
            boolean result = target.isShortestPossiblePushData();
            //Assert statement(s)
    ...
    public void writeWhenDataIsNull() throws IOException {
         ...
         */
        //Arrange Statement(s)
        ScriptChunk target = spy(new ScriptChunk(10, (byte[]) null));
    ...
    public void writeWhenDataIsNotNullThrowsIllegalStateException() throws IOException {
        ...
        try (MockedStatic<Preconditions> preconditions = mockStatic(Preconditions.class)) {
            ...
            byte[] byteArray = new byte[]{(byte) 2, (byte) 3};
            ScriptChunk target = spy(new ScriptChunk(1, byteArray));
            doReturn(true).when(target).isOpCode();
    ...
    public void writeWhenIsOpCodeNotAndDataIsNull() throws IOException {
         ...
         */
        //Arrange Statement(s)
        ScriptChunk target = spy(new ScriptChunk(256, (byte[]) null));
    ...
    public void writeWhenDataLengthEqualsOpcode() throws IOException {
        ...
        ScriptChunk target = spy(new ScriptChunk(5, byteArray));
        doReturn(false).when(target).isOpCode();
        OutputStream outputStream = OutputStream.nullOutputStream();
    ...
    public void writeWhenDataLengthLessThanOrEqualsTo65535() throws IOException {
        ...
        //Arrange Statement(s)
        byte[] byteArray = new byte[]{(byte) 0};
        ScriptChunk target = spy(new ScriptChunk(118, byteArray));
        doReturn(false).when(target).isOpCode();
    ...
    public void writeWhenDataLengthGreaterThan65535ThrowsIllegalStateException() throws IOException {
         ...
         */
        //Arrange Statement(s)
        byte[] byteArray = new byte[]{(byte) 0, (byte) 0, (byte) 1, (byte) 0};
    ...
    public void writeWhenDataLengthGreaterThanScriptMAX_SCRIPT_ELEMENT_SIZEThrowsIllegalStateException() throws IOException {
         ...
         */
        //Arrange Statement(s)
        byte[] byteArray = new byte[]{(byte) 72, (byte) 101, (byte) 108, (byte) 108, (byte) 111, (byte) 44, (byte) 32, (byte) 87, (byte) 111, (byte) 114, (byte) 108, (byte) 100, (byte) 33};
        ScriptChunk target = spy(new ScriptChunk(81, byteArray));
        doReturn(false).when(target).isOpCode();
        RuntimeException runtimeException = new RuntimeException("Unimplemented");
        thrown.expect(RuntimeException.class);
    ...
    public void toByteArrayWhenCaughtIOExceptionThrowsRuntimeException() throws IOException {
        ...
        doThrow(iOExceptionMock).when(target).write((ByteArrayOutputStream) any());
        thrown.expect(RuntimeException.class);
    ...
    public void sizeWhenOpcodeEqualsOP_PUSHDATA2AndDataIsNull() {
         ...
         */
        //Arrange Statement(s)
        ScriptChunk target = new ScriptChunk(2, (byte[]) null);
    ...
    public void sizeWhenOpcodeEqualsOP_PUSHDATA4AndDataIsNotNull() {
        ...
        //Arrange Statement(s)
        byte[] byteArray = new byte[]{(byte) 1, (byte) 2, (byte) 3};
        ScriptChunk target = new ScriptChunk(4, byteArray);
    ...
    public void toStringWhenDataIsNull() {
         ...
         */
        //Arrange Statement(s)
        try (MockedStatic<ScriptOpCodes> scriptOpCodes = mockStatic(ScriptOpCodes.class)) {
            scriptOpCodes.when(() -> ScriptOpCodes.getOpCodeName(1)).thenReturn("NON_OP(1)");
            ScriptChunk target = new ScriptChunk(1, (byte[]) null);
            //Act Statement(s)
            String result = target.toString();
            //Assert statement(s)
            assertThat(result, equalTo("NON_OP(1)"));
            scriptOpCodes.verify(() -> ScriptOpCodes.getOpCodeName(1), atLeast(1));
        }
    }
    ...
    public void toStringWhenDataIsNotNull() {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class);
             MockedStatic<ScriptOpCodes> scriptOpCodes = mockStatic(ScriptOpCodes.class)) {
            scriptOpCodes.when(() -> ScriptOpCodes.getPushDataName(0)).thenReturn("getPushDataName");
            byte[] byteArray = new byte[]{(byte) 1, (byte) 2, (byte) 3};
            ...
            String result = target.toString();
            //Assert statement(s)
            assertThat(result, equalTo("getPushDataName[formatHex]"));
            scriptOpCodes.verify(() -> ScriptOpCodes.getPushDataName(0), atLeast(1));
