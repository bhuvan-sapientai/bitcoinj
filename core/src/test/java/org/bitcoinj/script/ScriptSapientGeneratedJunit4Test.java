...
public class ScriptSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${18a19c7e-97b7-3ac3-8022-d3568bffd4fc}
    @Test()
    ...
    //Sapient generated method id: ${55525088-83be-30ba-841c-1e45a45a5425}
    @Test()
    ...
    //Sapient generated method id: ${380ea87f-6d87-3091-8945-631788c2d317}
    @Test()
    ...
    public void removeAllInstancesOfWhenOpcodeEqualsOP_PUSHDATA2AndSkipIsEmptyAndCaughtIOExceptionThrowsRuntimeException() throws IOException {
        ...
        try (MockedStatic<ByteUtils> byteUtils = mockStatic(ByteUtils.class)) {
            byte[] byteArray = new byte[]{(byte) 0};
            byteUtils.when(() -> ByteUtils.readUint16(byteArray, 1)).thenReturn(0);
            thrown.expect(RuntimeException.class);
            thrown.expectCause(is(instanceOf(IOException.class)));
            byte[] byteArray2 = new byte[]{(byte) 0, (byte) 1};
            //Act Statement(s)
    ...
    //Sapient generated method id: ${68e875cf-91d9-3f96-8bf1-84eb1dd62cc2}
    @Test()
    ...
    public void executeScriptWhenStackSizePlusAltstackSizeNotLessThan0AndIfStackIsEmpty3() throws Exception {
        ...
        //Act Statement(s)
        Script.executeScript(transaction, 2L, script, byteList, scriptVerifyFlagSet);
    }
